	...
	public void executeUpdate(String sql)
	{
	 ...
	 /** 
	  ...
	  public boolean update(BaseVo baseVo) {
		...
		StringBuffer sql=new StringBuffer();
		sql.append("update topo_node_telnetconfig set user ='");
	   ...
	   public boolean save(BaseVo basevo) {
		// TODO Auto-generated method stub
		   Huaweitelnetconf vo = (Huaweitelnetconf)basevo;	  
		   StringBuffer sql = new StringBuffer();
		   sql.append("insert into topo_node_telnetconfig(id,user,password,port,suuser,supassword,ip_address,default_promtp,enablevpn,is_synchronized,device_render,ostype)values(");
		   sql.append(vo.getId());
		   sql.append(",'");
		   sql.append(vo.getUser());
		   sql.append("','");
