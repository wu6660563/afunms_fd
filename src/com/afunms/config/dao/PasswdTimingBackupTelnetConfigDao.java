...
public class PasswdTimingBackupTelnetConfigDao extends BaseDao implements DaoInterface {
    ...
    public PasswdTimingBackupTelnetConfigDao(){
        super("sys_passwdtimingbackup_telnetconfig");
    }
    
    public boolean save(BaseVo vo) {
        PasswdTimingBackupTelnetConfig passwdTimingBackupTelnetConfig = (PasswdTimingBackupTelnetConfig)vo;
        StringBuffer sqlBuffer = new StringBuffer();
        sqlBuffer.append("insert into sys_passwdtimingbackup_telnetconfig(telnetconfigips,warntype,BACKUP_FILENAME,BACKUP_TYPE,");
    ...
    public boolean update(BaseVo vo) {
        PasswdTimingBackupTelnetConfig passwdTimingBackupTelnetConfig = (PasswdTimingBackupTelnetConfig)vo;
        StringBuffer sqlBuffer = new StringBuffer();
        sqlBuffer.append("update sys_passwdtimingbackup_telnetconfig set telnetconfigips = '");
        sqlBuffer.append(passwdTimingBackupTelnetConfig.getTelnetconfigips());
    ...
    public List<PasswdTimingBackupTelnetConfig> getAlList() {
        String sqlString = "select * from sys_passwdtimingbackup_telnetconfig";
    ...
    public boolean delete(String id) {
        ...
        try {
            conn.addBatch("delete from sys_passwdtimingbackup_telnetconfig where id=" + id);
            conn.executeBatch();
            result = true;
        } catch (Exception e) {
    ...
    public boolean updateStatus(String status,String id){
        ...
        sql.append("update sys_passwdtimingbackup_telnetconfig set status = '");
        sql.append(status);
        sql.append("' where id = '");
        sql.append(id);
        sql.append("'");
