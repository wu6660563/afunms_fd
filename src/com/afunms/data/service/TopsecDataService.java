/*
 * @(#)TopsecDataService.java     v1.01, Jan 16, 2013
 *
...
/**
 * ClassName:   TopsecDataService.java
 * <p>
 *
 * @author      聂林
 * @version     v1.01
 * @since       v1.01
 * @Date        Jan 16, 2013 10:30:39 AM
 */
public class TopsecDataService extends NodeDataService {
     ...
     * @param baseVo
     */
    public TopsecDataService(BaseVo baseVo) {
        super(baseVo);
    }
     ...
     * @param nodeDTO
     */
    public TopsecDataService(NodeDTO nodeDTO) {
        super(nodeDTO);
    }
     ...
     * @param subtype
     */
    public TopsecDataService(String nodeid, String type, String subtype) {
