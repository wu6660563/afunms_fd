...
public class SolarisDataService extends NodeDataService {

    private static final SysLogger logger = SysLogger
            .getLogger(SolarisDataService.class.getName());
     ...
     * @param baseVo
     */
    public SolarisDataService(BaseVo baseVo) {
        super(baseVo);
    }
     ...
     * @param nodeDTO
     */
    public SolarisDataService(NodeDTO nodeDTO) {
        super(nodeDTO);
    }
     ...
     * @param subtype
     */
    public SolarisDataService(String nodeid, String type, String subtype) {
