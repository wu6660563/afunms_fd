...
/**
 * 
 * ClassName: Tru64DataService.java
 * <p>
 * 
 * @author 吴品龙
 * @version v1.01
 ...
 */
public class Tru64DataService extends NodeDataService {

	private static final SysLogger logger = SysLogger
			.getLogger(Tru64DataService.class.getName());
	 ...
	 * @param baseVo
	 */
	public Tru64DataService(BaseVo baseVo) {
		super(baseVo);
	}
	 ...
	 * @param nodeDTO
	 */
	public Tru64DataService(NodeDTO nodeDTO) {
		super(nodeDTO);
	}
	 ...
	 * @param subtype
	 */
	public Tru64DataService(String nodeid, String type, String subtype) {
