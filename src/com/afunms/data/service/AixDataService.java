...
public class AixDataService extends NodeDataService {

    private static final SysLogger logger = SysLogger
            .getLogger(AixDataService.class.getName());
     ...
     * @param baseVo
     */
    public AixDataService(BaseVo baseVo) {
        super(baseVo);
    }
     ...
     * @param nodeDTO
     */
    public AixDataService(NodeDTO nodeDTO) {
        super(nodeDTO);
    }
     ...
     * @param subtype
     */
    public AixDataService(String nodeid, String type, String subtype) {
    ...
    public Vector getInterfaceInfo(String orderFlag, String sorttype) {
        ...
        try {
            vector = hostlastmanager.getInterface_share(getIpaddress(),
                    netInterfaceItem, orderFlag, starttime, endtime);
        } catch (Exception e) {
            e.printStackTrace();
        }
        // 排序
        vector = CommonUtil.sortInterface(vector, orderFlag, sorttype,
                netInterfaceItem);
        return vector;
    }
    ...
    // public String getAmWindowsDiskChartInfo(
    // Hashtable<Integer, Hashtable<String, String>> diskValueHashtable) {
    // CreateAmColumnPic createAmColumnPic = new CreateAmColumnPic();
    // String amDiskChartInfo = createAmColumnPic
    // .createWinDiskChart(diskValueHashtable);
    // return amDiskChartInfo;
    // }
