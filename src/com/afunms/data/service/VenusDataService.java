/*
 * @(#)VenusDataService.java     v1.01, Mar 26, 2013
 *
...
/**
 * 
 * ClassName:   VenusDataService.java
 * <p>
 *
 * @author      吴品龙
 * @version     v1.01
 * @since       v1.01
 * @Date        Mar 26, 2013 11:20:27 AM
 */

public class VenusDataService extends NodeDataService {

    private static final SysLogger logger = SysLogger
    .getLogger(VenusDataService.class.getName());
     ...
     * @param baseVo
     */
    public VenusDataService(BaseVo baseVo) {
        super(baseVo);
    }
     ...
     * @param nodeDTO
     */
    public VenusDataService(NodeDTO nodeDTO) {
        super(nodeDTO);
    }
     ...
     * @param subtype
     */
    public VenusDataService(String nodeid, String type, String subtype) {
...
//------------------------------------  Performance Info  ------------------------------------------------
     ...
     * <p>获取当天响应时间值的 {@link Hashtable<String, String>} 信息
     *
     * @return  {@link Hashtable<String, String>}
     *          - 响应时间值的 {@link Hashtable<String, String>} 信息
     *
     * @since   v1.01
     */
     ...
     * <p>获取当天 CPU 值的 {@link Hashtable<String, String>} 信息
     *
     * @return  {@link Hashtable<String, String>}
     *          - CPU 值的 {@link Hashtable<String, String>} 信息
     *
     * @since   v1.01
     */
     ...
     * <p>获取当前设备信息
     *
     * @return  {@link List<DeviceNodeTemp>}
     *          - 当前设备信息
     *
     * @since   v1.01
     */
     ...
     * <p>获取当前综合流速信息
     *
     * @return  {@link List<InterfaceInfo>}
     *          - 当前综合流速信息
     *
     * @since   v1.01
     */
     ...
     * <p>获取当天综合流速值的 {@link Hashtable<String, String>} 信息
     *
     * @return  {@link Hashtable<String, String>}
     *          - 当天综合流速值的 {@link Hashtable<String, String>} 信息
     *
     * @since   v1.01
     */
...
//------------------------------------  Router Info  ------------------------------------------------
     ...
     * <p>获取当前路由信息
     *
     * @return  {@link List<RouterNodeTemp>}
     *          - 路由信息
     *
     * @since   v1.01
     */
