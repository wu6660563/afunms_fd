/*
 * @(#)TopsecDataManager.java     v1.01, Jan 16, 2013
 *
...
/**
 * ClassName:   TopsecDataManager.java
 * <p> {@link TopsecDataManager} 天融信防火墙的详细信息控制类
 *
 * @author      聂林
 * @version     v1.01
 * @since       v1.01
 * @Date        Jan 16, 2013 10:27:20 AM
 */
public class TopsecDataManager extends NodeDataManager {
    ...
    public String getInterfaceInfo() {
        ...
        TopsecDataService dataService = getDataService();
        ...
        return "/detail/firewall/topsec/interface.jsp";
    }
    ...
    public String getPerformanceInfo() {
        ...
        return "/detail/firewall/topsec/performance.jsp";
    }
    ...
    public String getRouterInfo() {
        ...
        return "/detail/firewall/topsec/router.jsp";
    }
    ...
    public String getIpListInfo() {
        ...
        return "/detail/firewall/topsec/iplist.jsp";
    }
    ...
    public String getEventInfo() {
        ...
        return "/detail/firewall/topsec/event.jsp";
    }
     ...
     * @since   v1.01
     */
    public TopsecDataService getDataService() {
        String nodeid = getNodeid();
        String type = getType();
        String subtype = getSubtype();
        TopsecDataService dataService = new TopsecDataService(nodeid,
                type, subtype);
        return dataService;
    }
}
