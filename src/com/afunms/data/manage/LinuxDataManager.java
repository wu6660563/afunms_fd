 ...
 */
public class LinuxDataManager extends NodeDataManager {

    private static final SysLogger sysLogger = SysLogger
            .getLogger(LinuxDataManager.class.getName());
    ...
    public LinuxDataService getDataService() {
        String nodeid = getNodeid();
        String type = getType();
        String subtype = getSubtype();
        LinuxDataService linuxDataService = new LinuxDataService(nodeid,
                type, subtype);
    ...
    public String getInterfaceInfo() {
        getBaseInfo();
        LinuxDataService dataService = getDataService();
        ...
        try {
        	list = portconfigDao.loadByIpaddress(dataService.getNodeDTO().getIpaddress());
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            portconfigDao.close();
        ...
        return "/detail/host/linux/interface.jsp";
    }
...
//
        ...
        return "/detail/host/linux/performance.jsp";
    }
    ...
    public String getFileSystemInfo() {
        ...
        return "/detail/host/linux/filesystem.jsp";
    }
    ...
    public String getConfigInfo() {
        ...
        return "/detail/host/linux/config.jsp";
    }
    ...
    public String getServiceInfo() {
        ...
        return "/detail/host/linux/service.jsp";
    }
    ...
    public String getSyslogInfo() {
        ...
        return "/detail/host/linux/syslog.jsp";
    }
    ...
    public String getEventInfo() {
        ...
        request.setAttribute("startdate", startdate);
        request.setAttribute("todate", todate);
        return "/detail/host/linux/event.jsp";
    }
    ...
    public void getBaseInfo() {
        ...
        String curPhysicalMemoryValue = "0";
        String curSwapMemoryValue = "0";
        
        String curPingValue = "0";
        String curResponseTimeValue = "0";          // 名称
        String curCPUValue = "0";
        ...
        if(curPhysicalMemoryValue==null||curPhysicalMemoryValue.trim().length()==0){
        	curPhysicalMemoryValue = "0";
        }
    ...
    private String getProcessInfo() {
      ...
      //wupinlong add 添加关键的，设置关键的为可以查看历史记录
        ...
        return "/detail/host/linux/process.jsp";
    }
