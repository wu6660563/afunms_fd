/*
 * @(#)H3CFireWallDataManager.java     v1.01, Aug 19, 2013
 *
...
import com.afunms.data.service.H3CFireWallDataService;
...
/**
 * 
 * ClassName:   H3CFireWallDataManager.java
 * <p>
 *
 * @author      吴品龙
 * @version     v1.01
 * @since       v1.01
 * @Date        Sep 6, 2013 11:04:24 AM
 * @mail		wupinlong@dhcc.com.cn
 */
public class H3CFireWallDataManager extends NodeDataManager {
    ...
    public String getInterfaceInfo() {
        getBaseInfo();
        H3CFireWallDataService dataService = getDataService();
        ...
        try {
            if ("0".equals(important)) {
                ...
                important = "1";
                list = portconfigDao.findByImportant(dataService.getNodeDTO().getIpaddress(), important);
            }
        ...
        return "/detail/firewall/h3c/interface.jsp";
    }
    ...
    public String getPerformanceInfo() {
        ...
        return "/detail/firewall/h3c/performance.jsp";
    }
    ...
    public String getRouterInfo() {
        getBaseInfo();
        H3CFireWallDataService dataService = getDataService();
        List<RouterNodeTemp> routerNodeTempList = dataService.getCurRouterInfo();
        request.setAttribute("routerNodeTempList", routerNodeTempList);
        return "/detail/firewall/h3c/router.jsp";
    }
    ...
    public String getIpListInfo() {
        ...
        return "/detail/firewall/h3c/iplist.jsp";
    }
    ...
    public String getEventInfo() {
        ...
        return "/detail/firewall/h3c/event.jsp";
    }
     ...
     * <p>获取数据服务类
     *
     * @return  {@link H3CFireWallDataService}
     *          - 
     *
     * @since   v1.01
     */
    public H3CFireWallDataService getDataService() {
        String nodeid = getNodeid();
        String type = getType();
        String subtype = getSubtype();
        H3CFireWallDataService dataService = new H3CFireWallDataService(nodeid,
                type, subtype);
        return dataService;
    }
}
