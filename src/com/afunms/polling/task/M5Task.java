...
//        			threadPool.runTask(createTask(nodeGatherIndicators,alldata));           		
        		...
        		try{
        			File file=null;
        			try{
            			String filename = ResourceCenter.getInstance().getSysPath() + "linuxserver/net_ping.xml";				
            			 file=new File(filename);
            			if(file.exists()){
            				try{
            					pingHash=xmlutil.parserNetWorkXml(ResourceCenter.getInstance().getSysPath()+ "linuxserver/net_ping.xml","ping");
            			...
            			filename = ResourceCenter.getInstance().getSysPath()+ "linuxserver/net_systemgroup.xml";				
            			file=new File(filename);
            			if(file.exists()){
            				try{
            			...
            			filename = ResourceCenter.getInstance().getSysPath() + "linuxserver/net_cpu.xml";				
            			file=new File(filename);
            			if(file.exists()){
            				try{
            			...
            			filename = ResourceCenter.getInstance().getSysPath() + "linuxserver/net_mem.xml";				
            			file=new File(filename);
            			if(file.exists()){
            				try{
            			...
            			filename = ResourceCenter.getInstance().getSysPath() + "linuxserver/net_envir.xml";				
            			file=new File(filename);
            			if(file.exists()){
            				try{
            					powerHash = xmlutil.parserNetWorkXml(filename,"power");
            			...
            			if(file.exists()){
            				try{
            					fanHash = xmlutil.parserNetWorkXml(filename,"fan");
            			...
            			if(file.exists()){
            				try{
            					flashHash = xmlutil.parserNetWorkXml(filename,"flash");
            			...
            			if(file.exists()){
            				try{
            					temperatureHash = xmlutil.parserNetWorkXml(filename,"temperature");
            			...
            			if(file.exists()){
            				try{
            					voltageHash = xmlutil.parserNetWorkXml(filename,"voltage");
            			...
            			filename = ResourceCenter.getInstance().getSysPath()+ "linuxserver/net_fdb.xml";				
            			file=new File(filename);
            			if(file.exists()){
            				try{
            					fdbHash = xmlutil.parserFdbXml(filename);
...
//                    				SysLogger.info("############################################################");
                    		...
                    		if(node != null){
                    			...
                    			}if(alarmIndicatorsNode.getSubtype().equalsIgnoreCase("brocade")){
                    				//博科风扇
