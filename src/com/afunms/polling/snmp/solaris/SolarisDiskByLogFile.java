 ...
 * @author 聂林
 */
public class SolarisDiskByLogFile extends SolarisByLogFile {

    /**
     * 日志
     */
    private static SysLogger logger = SysLogger
            .getLogger(SolarisDiskByLogFile.class.getName());

    private static final String SOLARIS_DISK_BEGIN_KEYWORD = SolarisLogFileKeywordConstant.SOLARIS_DISK_BEGIN_KEYWORD;

    private static final String SOLARIS_DISK_END_KEYWORD = SolarisLogFileKeywordConstant.SOLARIS_DISK_END_KEYWORD;

    @Override
    public ObjectValue getObjectValue() {
        String beginStr = SOLARIS_DISK_BEGIN_KEYWORD;
        String endStr = SOLARIS_DISK_END_KEYWORD;
