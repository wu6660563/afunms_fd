/*
 * @(#)VenusMemorySnmp.java     v1.01, Mar 25, 2013
 *
...
/**
 * 
 * ClassName: VenusMemorySnmp.java
 * <p>
 * 
 * @author 吴品龙
 * @version v1.01
 * @since v1.01
 * @Date Mar 25, 2013 8:54:54 PM
 */

public class VenusMemorySnmp extends SnmpMonitor implements IndicatorGather {
    ...
    public Result getValue(Node node, NodeGatherIndicators nodeGatherIndicators) {
        ...
        try {
            Host host = (Host) node;
            String[] oids = new String[] { "1.3.6.1.4.1.15227.1.3.1.1.2" };	//启明星辰：天清汉马USG
