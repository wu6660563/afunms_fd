/*
 * @(#)SNMPTrapHandlerImpl.java     v1.01, Dec 5, 2012
 *
...
/**
 * ClassName:   SNMPTrapHandlerImpl.java
 * <p> snmp Trap 实现类
 *
 * @author      聂林
 * @version     v1.01
 * @since       v1.01
 * @Date        Dec 5, 2012 4:14:41 PM
 */
public class SNMPTrapHandlerImpl implements SNMPTrapHandler {
     ...
     * @since   v1.01
     */
    private static final long serialVersionUID = -5611172633887938042L;

    private static SysLogger logger = SysLogger.getLogger(SNMPTrapHandlerImpl.class);
     ...
     * @param event
     */
    private void processIManagerSNMP(CommandResponderEvent event) {
