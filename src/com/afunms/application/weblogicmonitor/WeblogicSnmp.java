...
public class WeblogicSnmp extends AbstractSnmp {
    ...
    public WeblogicSnmp(String host, String community, Integer port) {
        ...
        // System.out.println("Start collect data as ip "+nethost+"
        // "+community+" "+port);
        this.nethost = host;
    }
            ...
            try {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if (vb != null) {
                        ...
                        EntreaSysModle = vb[0].toString().substring(
                                vb[0].toString().indexOf("=") + 1,
                                vb[0].toString().length()).trim();
                        ...
                        for (int j = 0; j < vb.length; j++) {
                            ...
                            if (vb[j] != null) {
                                ...
                                sValue = vbString.substring(
                                        vbString.lastIndexOf("=") + 1,
                                        vbString.length()).trim();
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if (vb != null) {
                        ...
                        for (int j = 0; j < vb.length; j++) {
                            if (vb[j] != null) {
                                vbString = vb[j].toString();
                                String sValue = vbString.substring(
                                        vbString.lastIndexOf("=") + 1,
                                        vbString.length()).trim();
                                if (j == 0) {
                                    trans
                                            .setTransactionResourceRuntimeResourceName(sValue);
                                } else if (j == 1) {
                                    trans
                                            .setTransactionResourceRuntimeTransactionTotalCount(sValue);
                                } else if (j == 2) {
                                    trans
                                            .setTransactionResourceRuntimeTransactionCommittedTotalCount(sValue);
                                } else if (j == 3) {
                                    trans
                                            .setTransactionResourceRuntimeTransactionRolledBackTotalCount(sValue);
                                } else if (j == 4) {
                                    trans
                                            .setTransactionResourceRuntimeTransactionHeuristicsTotalCount(sValue);
                                } else if (j == 5) {
                                    trans
                                            .setTransactionResourceRuntimeTransactionHeuristicCommitTotalCount(sValue);
                                } else if (j == 6) {
                                    trans
                                            .setTransactionResourceRuntimeTransactionHeuristicRollbackTotalCount(sValue);
                                } else if (j == 7) {
                                    trans
                                            .setTransactionResourceRuntimeTransactionHeuristicMixedTotalCount(sValue);
                                } else if (j == 8) {
                                    trans
                                            .setTransactionResourceRuntimeTransactionHeuristicHazardTotalCount(sValue);
                                }
                            }
                        }
                        transList.add(trans);
                        ...
                        for (int j = 0; j < vb.length; j++) {
                            if (vb[j] != null) {
                                ...
                                if (j == 0) {
                                    ...
                                    normal
                                            .setDomainConfigurationVersion(sValue);
                                }
                            }
                        }
                        // normalList.add(normal);
                    ...
                    if (vb != null) {
                        ...
                        for (int j = 0; j < vb.length; j++) {
                            ...
                            if (j == 0) {
                                ...
                                servlet
                                        .setServletRuntimeReloadTotalCount(sValue);
                            } else if (j == 4) {
                                servlet
                                        .setServletRuntimeInvocationTotalCount(sValue);
                            } else if (j == 5) {
                                servlet
                                        .setServletRuntimePoolMaxCapacity(sValue);
                            } else if (j == 6) {
                                servlet
                                        .setServletRuntimeExecutionTimeTotal(sValue);
                            } else if (j == 7) {
                                servlet
                                        .setServletRuntimeExecutionTimeHigh(sValue);
                            } else if (j == 8) {
                                servlet
                                        .setServletRuntimeExecutionTimeLow(sValue);
                            } else if (j == 9) {
                                servlet
                                        .setServletRuntimeExecutionTimeAverage(sValue);
                            } else if (j == 10) {
    ...
    public List collectQueueData() {
        ...
        String[] oids = new String[] { ".1.3.6.1.4.1.140.625.180.1.15",
                    ...
                    for (int j = 0; j < vb.length; j++) {
                        if (vb[j] != null) {
                            ...
                            if (j == 0) {
                                ...
                                queue
                                        .setThreadPoolRuntimeExecuteThreadIdleCount(sValue);
                            } else if (j == 2) {
                                queue
                                        .setExecuteQueueRuntimePendingRequestOldestTime(sValue);
                            } else if (j == 3) {
                                queue
                                        .setExecuteQueueRuntimePendingRequestCurrentCount(sValue);
                            } else if (j == 4) {
                                queue
                                        .setExecuteQueueRuntimePendingRequestTotalCount(sValue);
                            }
                    ...
                    for (int j = 0; j < vb.length; j++) {
                        if (vb[j] != null) {
                            ...
                            if (j == 0) {
                                ...
                                jdbc
                                        .setJdbcConnectionPoolRuntimeActiveConnectionsCurrentCount(sValue);
                            } else if (j == 2) {
                                jdbc
                                        .setJdbcConnectionPoolRuntimeVersionJDBCDriver(sValue);
                            } else if (j == 3) {
                                jdbc
                                        .setJdbcConnectionPoolRuntimeMaxCapacity(sValue);
                            } else if (j == 4) {
                                jdbc
                                        .setJdbcConnectionPoolRuntimeActiveConnectionsAverageCount(sValue);
                            } else if (j == 5) {
                                jdbc
                                        .setJdbcConnectionPoolRuntimeHighestNumAvailable(sValue);
                            } else if (j == 6) {
                ...
                if (vb != null) {
                    ...
                    for (int j = 0; j < vb.length; j++) {
                        if (vb[j] != null) {
                            ...
                            if (j == 0) {
                                web
                                        .setWebAppComponentRuntimeComponentName(sValue);
                            } else if (j == 1) {
                                web.setWebAppComponentRuntimeStatus(sValue);
                            } else if (j == 2) {
                                web
                                        .setWebAppComponentRuntimeOpenSessionsCurrentCount(sValue);
                            } else if (j == 3) {
                                web
                                        .setWebAppComponentRuntimeOpenSessionsHighCount(sValue);
                            } else if (j == 4) {
                                web
                                        .setWebAppComponentRuntimeSessionsOpenedTotalCount(sValue);
                            }
                    ...
                    for (int j = 0; j < vb.length; j++) {
                        if (vb[j] != null) {
                            ...
                            if (j == 0) {
                                ...
                                server
                                        .setServerRuntimeOpenSocketsCurrentCount(sValue);
                            } else if (j == 4) {
    ...
    // WeblogicSnmp dd = new WeblogicSnmp("172.16.2.10","public",new
    // Integer(163));
