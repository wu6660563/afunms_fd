...
//					end_vector = hostlastmanager.getInterface(endnode.getIpAddress(),netInterfaceItem,"index","","");
				...
				Float downspeed = (Float.parseFloat(start_oututilhdx.replaceAll("KB/秒", "").replaceAll("kb/s", "").replaceAll("kb/秒", "").replaceAll("KB/S", "").replaceAll("KB/s", "")) + 
						Float.parseFloat(end_inutilhdx.replaceAll("KB/秒", "").replaceAll("kb/s", "").replaceAll("kb/秒", "").replaceAll("KB/S", "").replaceAll("KB/s", ""))) / 2;
				Float upspeed = (Float.parseFloat(start_inutilhdx.replaceAll("KB/秒", "").replaceAll("kb/s", "").replaceAll("kb/秒", "").replaceAll("KB/S", "").replaceAll("KB/s", "")) + 
						Float.parseFloat(end_oututilhdx.replaceAll("KB/秒", "").replaceAll("kb/s", "").replaceAll("kb/秒", "").replaceAll("KB/S", "").replaceAll("KB/s", ""))) / 2;
