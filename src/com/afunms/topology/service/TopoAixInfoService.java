...
public class TopoAixInfoService extends TopoNodeInfoService {

    private AixDataService aixDataService;
    ...
    public AixDataService getAixDataService() {
        if (aixDataService == null) {
            String nodeid = getNodeid();
            String type = getType();
            String subtype = getSubtype();
            aixDataService = new AixDataService(nodeid, type, subtype);
        }
        return aixDataService;
    }

    public String getPingInfo() {
        // 当前连通率和响应时间
        String curPingValue = "0";               // 可用性
        List<NodeTemp> pingList = getAixDataService().getPingInfo();
    ...
    public String getCPUInfo() {
        ...
        String curCPUValueTemp = getAixDataService().getCPUInfo();
    ...
    public String[] getMemoryInfo() {
        ...
        List<NodeTemp> curMemoryValueList = getAixDataService().getMemoryInfo();
    ...
    public String[][] getDiskInfo() {
        ...
        Hashtable<Integer, Hashtable<String, String>> curDayDiskValueHashtable = getAixDataService()
