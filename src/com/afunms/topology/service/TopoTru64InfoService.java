...
/**
 * 
 * ClassName:   TopoTru64InfoService.java
 * <p>
 *
 * @author      吴品龙
 * @version     v1.01
 ...
 */
public class TopoTru64InfoService  extends TopoNodeInfoService {

	private Tru64DataService tru64DataService;
	...
	public Tru64DataService getTru64DataService() {
        if (tru64DataService == null) {
            String nodeid = getNodeid();
            String type = getType();
            String subtype = getSubtype();
            tru64DataService = new Tru64DataService(nodeid, type, subtype);
        }
        return tru64DataService;
    }
	
	public String getPingInfo() {
        // 当前连通率和响应时间
        String curPingValue = "0";               // 可用性
        List<NodeTemp> pingList = getTru64DataService().getPingInfo();
	...
	public String getCPUInfo() {
        ...
        String curCPUValueTemp = getTru64DataService().getCPUInfo();
    ...
    public String[] getMemoryInfo() {
        ...
        List<NodeTemp> curMemoryValueList = getTru64DataService().getMemoryInfo();
    ...
    public String[][] getDiskInfo() {
        ...
        Hashtable<Integer, Hashtable<String, String>> curDayDiskValueHashtable = getTru64DataService()
