...
/**
 * ClassName:   TopoTopsecInfoService.java
 * <p>
 *
 * @author      吴品龙
 * @version     v1.01
 ...
 */
public class TopoTopsecInfoService extends TopoNodeInfoService  {

	private TopsecDataService topsecDataService;
	...
	public TopsecDataService getTopsecDataService() {
        if (topsecDataService == null) {
            String nodeid = getNodeid();
            String type = getType();
            String subtype = getSubtype();
            topsecDataService = new TopsecDataService(nodeid, type, subtype);
        }
        return topsecDataService;
    }
	
	public String getPingInfo() {
        // 当前连通率和响应时间
        String curPingValue = "0";               // 可用性
        List<NodeTemp> pingList = getTopsecDataService().getPingInfo();
	...
	public String getCPUInfo() {
        ...
        String curCPUValueTemp = getTopsecDataService().getCPUInfo();
    ...
    public String[] getMemoryInfo() {
        ...
        List<NodeTemp> curMemoryValueList = getTopsecDataService().getMemoryInfo();
    ...
    public String[] getAllBandwidthUtilHdx() {
        ...
        List<InterfaceInfo> curAllBandwidthUtilHdxList = getTopsecDataService()
