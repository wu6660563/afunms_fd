...
public class Link extends BaseVo {
    ...
    private String cableType;// yangjun add

    private String cableCapacity;// yangjun add
     ...
     */
    public String getCableCapacity() {
     ...
     */
    public void setCableCapacity(String cableCapacity) {
