...
//			systemValueForAS400.setId(rs.getInt("id"));
			...
			diskForAS400.setCollectTime(rs.getString("collectTime"));
	...
	public boolean save(BaseVo vo) {
		...
		sql.append("insert into nms_as400_disk(nodeid,ipaddress," +
				"unit,type,sizes,used,io_rqs,request_size,read_rqs,write_rqs,read,write,busy,collect_time) values('");
