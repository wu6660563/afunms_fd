                ...
                try {
                    ...
                    if (node.getEndpoint() == 2) {
                        ...
                        if (node.getCollecttype() == SystemConstant.COLLECTTYPE_PING
                            ...
                            SysLogger
                                    .info("只PING TELNET SSH方式检测可用性,性能数据不采集,跳过");
                        } else {
...
//                ctable.deleteTable(conn, "cpuday", allipstr, "cpuday");// CPU
//
//                ctable.deleteTable(conn, "memory", allipstr, "memory");// 内存
//                ctable.deleteTable(conn, "memoryhour", allipstr, "memoryhour");// 内存
//                ctable.deleteTable(conn, "memoryday", allipstr, "memoryday");// 内存
//                // 不在采集
//                // ctable.deleteTable(conn,"flash",allipstr,"flash");//闪存
//                // ctable.deleteTable(conn,"flashhour",allipstr,"flashhour");//闪存
//                // ctable.deleteTable(conn,"flashday",allipstr,"flashday");//闪存
...
//                // ctable.deleteTable(conn,"volday",allipstr,"volday");//电压
//
//                ctable.deleteTable(conn, "utilhdx", allipstr, "utilhdx");// 单个端口流速
//                ctable.deleteTable(conn, "utilhdxhour", allipstr, "utilhdxhour");// 单个端口流速
//                ctable.deleteTable(conn, "utilhdxday", allipstr, "utilhdxday");// 单个端口流速
//
//                ctable.deleteTable(conn, "allutilhdx", allipstr, "allutilhdx");// 端口总流速
//                ctable.deleteTable(conn, "allutilhdxhour", allipstr,
//                        "allutilhdxhour");// 端口总流速
//                ctable
//                        .deleteTable(conn, "allutilhdxday", allipstr,
//                                "allutilhdxday");// 端口总流速
//
//                ctable.deleteTable(conn, "utilhdxperc", allipstr, "utilhdxperc");// 带宽
//                ctable.deleteTable(conn, "utilhdxperchour", allipstr, "utilhdxperchour");// 带宽
//                ctable.deleteTable(conn, "utilhdxpercday", allipstr, "utilhdxpercday");// 带宽
//
//                ctable.deleteTable(conn, "discardsperc", allipstr, "discardsperc");// 丢包率
//                ctable.deleteTable(conn, "discardsperchour", allipstr,
//                        "discardsperchour");// 丢包率
//                ctable.deleteTable(conn, "discardspercday", allipstr,
//                        "discardspercday");// 丢包率
//
//                ctable.deleteTable(conn, "errorsperc", allipstr, "errorsperc");// 错包率
//                ctable
//                        .deleteTable(conn, "errorsperchour", allipstr,
//                                "errorsperchour");// 错包率
//                ctable.deleteTable(conn, "errorspercday", allipstr, "errorspercday");// 错包率
//
...
//             // 不在采集
////                ctable.createTable(conn,"temper",allipstr,"temper");//温度
////                ctable.createTable(conn,"temperhour",allipstr,"temperhour");//温度
////                ctable.createTable(conn,"temperday",allipstr,"temperday");//温度
////
////                ctable.createTable(conn,"fan",allipstr,"fan");//风扇
...
////                ctable.createTable(conn,"volday",allipstr,"volday");//电压
//                
//                ctable.createTable(conn,"utilhdx",allipstr,"hdx");//单个端口流速
//                ctable.createTable(conn,"utilhdxhour",allipstr,"hdxhour");//单个端口流速
//                ctable.createTable(conn,"utilhdxday",allipstr,"hdxday");//单个端口流速
//                
//                ctable.createTable(conn,"allutilhdx",allipstr,"allhdx");//端口总流速
//                ctable.createTable(conn,"allutilhdxhour",allipstr,"allhdxhour");//端口总流速
//                ctable.createTable(conn,"allutilhdxday",allipstr,"allhdxday");//端口总流速
//                
//                ctable.createTable(conn,"utilhdxperc",allipstr,"hdperc");//带宽
//                ctable.createTable(conn,"hdxperchour",allipstr,"hdperchour");//带宽
//                ctable.createTable(conn,"hdxpercday",allipstr,"hdpercday");//带宽
//                
//                ctable.createTable(conn,"discardsperc",allipstr,"dcardperc");//丢包率
//                ctable.createTable(conn,"dcardperchour",allipstr,"dcardperchour");//丢包率
//                ctable.createTable(conn,"dcardpercday",allipstr,"dcardpercday");//丢包率
//                
//                ctable.createTable(conn,"errorsperc",allipstr,"errperc");//错包率
//                ctable.createTable(conn,"errperchour",allipstr,"errperchour");//错包率
//                ctable.createTable(conn,"errpercday",allipstr,"errpercday");//错包率
//                
//                ctable.createTable(conn,"packs",allipstr,"packs");//数据包总数
//                ctable.createTable(conn,"packshour",allipstr,"packshour");//数据包总数
//                ctable.createTable(conn,"packsday",allipstr,"packsday");//数据包总数
//                
//                ctable.createTable(conn,"inpacks",allipstr,"inpacks");//数据包总数
//                ctable.createTable(conn,"inpackshour",allipstr,"inpackshour");//数据包总数
//                ctable.createTable(conn,"inpacksday",allipstr,"inpacksday");//数据包总数
//                
//                ctable.createTable(conn,"outpacks",allipstr,"outpacks"); //数据包总数   
//                ctable.createTable(conn,"outpackshour",allipstr,"outpackshour");//数据包总数
//                ctable.createTable(conn,"outpacksday",allipstr,"outpacksday");//数据包总数
//
//                ctable.createTable(conn,"pro",allipstr,"pro");//进程
...
//
//                ctable.createTable(conn,"disk",allipstr,"disk");//磁盘利用率
//                ctable.createTable(conn,"diskhour",allipstr,"diskhour");//磁盘利用率
//                ctable.createTable(conn,"diskday",allipstr,"diskday");//磁盘利用率
//                
...
//                
//                ctable.createTable(conn,"pgused",allipstr,"pgused");//生成换页率  
//                ctable.createTable(conn,"pgusedhour",allipstr,"pgusedhour");//生成换页率
//                ctable.createTable(conn,"pgusedday",allipstr,"pgusedday");//生成换页率
                ...
                ctable.createTable(conn,"portstatus",allipstr,"port");//端口状态
                //  ctable.createTable(conn,"portstatushour",allipstr,"porthour");
                //  ctable.createTable(conn,"portstatusday",allipstr,"portday");
                
                ctable.createTable(conn,"nms_interface_data_temp",allipstr,"interface");//端口临时
                
                ctable.createTable(conn,"nms_process_data_temp",allipstr,"process");//进程临时
