...
public class AlarmIndicatorsDao extends BaseDao implements DaoInterface{
	...
	public BaseVo loadFromRS(ResultSet rs) {
		...
		try {
			...
			alarmIndicators.setPriorityLevel(rs.getInt("priority_level"));
	...
	public boolean save(BaseVo vo) {
		...
		sql.append("insert into nms_alarm_indicators(name, type, subtype, priority_level, datatype, moid, threshold, " +
		...
		sql.append("',");
		sql.append(alarmIndicators.getPriorityLevel());
		sql.append(",'");
