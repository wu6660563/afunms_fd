...
public class AlarmWayDao extends BaseDao implements DaoInterface{
	...
	public BaseVo loadFromRS(ResultSet rs) {
		...
		try {
			...
			alarmWay.setIsFvsdAlarm(rs.getString("is_fvsd_alarm"));
	...
	public boolean save(BaseVo vo) {
		...
		sql.append("insert into nms_alarm_way(id,name,description,is_default," +
				"is_page_alarm,is_sound_alarm,is_phone_alarm,is_sms_alarm,is_mail_alarm,is_desktop_alarm,is_fvsd_alarm" +
				") values('");
		...
		sql.append("','");
        sql.append(alarmWay.getIsFvsdAlarm());
		sql.append("')");
    ...
    public List<AlarmWay> findIsDefault(String is_default) {
        String sql = "select * from nms_alarm_way where is_default ='" + is_default + "'";
