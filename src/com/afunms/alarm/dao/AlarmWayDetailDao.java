...
public class AlarmWayDetailDao extends BaseDao implements DaoInterface{
	...
	public BaseVo loadFromRS(ResultSet rs) {
		...
		try {
			...
			alarmWayDetail.setSendIntervalTimes(rs.getString("sendIntervalTimes"));
	...
	public boolean save(BaseVo vo) {
		...
		sql.append("insert into nms_alarm_way_detail(alarm_way_id,alarm_category,date_type," +
				"send_times,start_date,end_date,start_time,end_time,user_ids,sendIntervalTimes" +
				") values('");
		...
		sql.append("','");
		sql.append(alarmWayDetail.getSendIntervalTimes());
		sql.append("')");
