...
function init2() {
	...
	for(int i = 0; i < list.size(); i++) {
		...
		for(int j = 0; j < list2.size(); j++) {
			...
			String nodeid = nodeDTO.getNodeid();	// 设备id 和设备type确定一条告警记录
			String nodeType = nodeDTO.getType();    // 设备type
																	...
																	<td>
																		...
																		<table id="report-data-body" class="report-data-body">
																			<tr height=50>
																				...
																				<td class="report-data-body-title">
																					<input type="button" name="nodeAlarmPerDay" value="业务视图设备每日告警数统计报表"
																							onclick="popupReport('nodeAlarmPerDay')">
																				</td>
																				<td class="report-data-body-title">
																					<input type="button" name="nodeAlarmPerHour"
																						value="业务视图设备每时告警数统计报表"
