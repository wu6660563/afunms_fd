...
function popupReport(reportName){
	...
	if("alarmPerHour" == reportName){
		 window.open('<%=rootPath%>/bios_report/reportWrapper.jsp?rpt=' + reportName + '.brt&starttime=' + starttime + ';endtime=' + endtime +';startdate='+ startdate +';enddate='+todate,
		 	'告警类别汇总报表','top=30,left=150,height=900,width=850,toolbar=no, menubar=no,location=no,status=no,scrollbars=yes');
		
	}else{
		 window.open('<%=rootPath%>/bios_report/reportWrapper.jsp?rpt=' + reportName + '.brt&starttime=' + starttime + ';endtime=' + endtime,'告警类别汇总报表','top=100,left=200,height=600,width=780,toolbar=no, menubar=no,location=no,status=no,scrollbars=yes');
				        											...
				        											<table id="report-data-body" class="report-data-body">
				        												...
				        												<tr height=50>
																	    	<td class="report-data-body-title"><input type="button" 
																	    		name="alarmByLevelPie" value="告警类别汇总报表" 
																	    		onclick="popupReport('alarmByLevelPie')"></td>
												
																	        <td class="report-data-body-title"><input type="button" 
																	    		name="alarmPerDay" value="每日告警数统计报表" 
																	    		onclick="popupReport('alarmPerDay')"></td>
																	    	
																	    	<td class="report-data-body-title"><input type="button" 
																	    		name="alarmPerHourLine" value="每时告警数统计报表" 
																	    		onclick="popupReport('alarmPerHourLine')"></td>
																	   </tr>
																	</table>
																</td>
															</tr>
