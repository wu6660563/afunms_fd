		...
		if (result) {
			...
			if(reportName == 'nodeAlarmCnt'){
				...
				window.open('<%=rootPath%>/bios_report/reportWrapper.jsp?rpt=' + reportName + '.brt&starttime=' 
					+ starttime + ';endtime=' + endtime +';query=' + sqlCondition+';nodeNum='+nodeNum ,'设备告警报表','height=690,width=800,toolbar=no,menubar=no,location=no,status=no,scrollbars=yes,resizable=no');		
																		...
																		<table id="report-data-body" class="report-data-body">
																			<tr height=50>
																				<td class="report-data-body-title">
																					<input type="button" name="nodeAlarmCnt" value="设备告警数统计报表"
																									onclick="popupReport('nodeAlarmCnt')">
																				<td class="report-data-body-title">
																					<input type="button" name="nodeAlarmPerDay" value="设备每日告警数统计报表"
																									onclick="popupReport('nodeAlarmPerDay')">
																				</td>
																				
																				<td class="report-data-body-title">
																					<input type="button" name="nodeAlarmPerHour" value="设备每时告警数统计报表"
