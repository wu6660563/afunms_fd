		...
		<script language="JavaScript">
			...
			*/
			...
			function relatedNode(){
				window.open('<%=rootPath%>/nodeReport.do?action=relatedNode','relatedNode','height=500,width=800,toolbar=no,menubar=no,location=no,status=no,scrollbars=yes,resizable=yes');
			}
															...
															<table>
																<tr>
													    			<td  class="body-data-title" style="text-align: right;">
							    										<a href="#" onclick="add()" style="display: <%=createOperationDisable%>">添加</a>&nbsp;&nbsp;&nbsp;
							    										<a href="#" onclick="toDelete()" style="display: <%=deleteOperationDisable%>">删除</a>&nbsp;&nbsp;&nbsp;
							    										<a href="#" onclick="relatedNode()" style="display:none">关联设备</a>
							        								</td>
							        							</tr>
															</table>
														</td>
														...
														<td>
															<table>
																<tr>
                                                                    ...
                                                                    <td class="body-data-title">发送至服务台</td> -->
