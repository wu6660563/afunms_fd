...
function save() {
	...
	if(linkname.replace(/(^\s*)|(\s*$)/g,'') == ""){
		alert("告警组名称不能为空！");
		document.mainForm.linkname.focus();
		return;
	}
	 mainForm.action = "<%=rootPath%>/alarmlink.do?action=addLinkType";
        mainForm.submit();
}
								...
								<table id="container-main-add" class="container-main-add">
									<tr>
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title"> 告警 >> 告警配置 >> 告警组名称信息 >> 添加告警组信息</td>
								     ...
								     <tr style="background-color: #ECECEC;">						
									    <TD nowrap align="center" >&nbsp; 告警组名称 &nbsp;&nbsp;&nbsp;
										<input type="text" id="linkname" name="linkname" maxlength="80" size="30" class="formStyle" value="<%=request.getAttribute("linkname") %>">
