...
<html>
											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 资源 >> 告警阀值 >> 告警阀值组列表 </td>
													...
													<tr>
														<td>
															...
															<td class="body-data-title" width=5%>
													    			...
													    			<td class="body-data-title" width=8%>组名称</td>
							        								...
							        								if(list != null && list.size() > 0) {
							        									...
							        									//	System.out.println(alarmLinkNode.getNodeid());
							        										...
							        										%>
							        											...
							        											<td class="body-data-list"><%=linkName%></td><!-- 组名称 -->
																	    		<td class="body-data-list"><%=deviceName%></td><!-- 设备名称 -->
																    			<td class="body-data-list" ><%=ipaddress%></td><!-- IP -->
																    			<td class="body-data-list" ><%=alarmLinkNode.getName()%></td><!-- 阀值名 -->
										        								...
										        								<td align="center" class="body-data-list">
																					<img src="<%=rootPath%>/resource/image/status.gif"
																						border="0" width=15 oncontextmenu=showMenu('2','<%=alarmLinkNode.getId()%>','','1111') title="右键菜单">
						       													</td>
											        							</tr>
							        										<%
	...
	<script>
		...
		function chanageLinkNode() {
			...
			linkid.length = 0;
			linkid.options[0] = new Option("不限","-1");
			var k=1;
			for(var i=0; i<nodeArray.length; i++){
