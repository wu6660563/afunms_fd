																			...
																			<tr>
																				<td width=100% align=center>
																					<table cellpadding="0" cellspacing="1"
																						...
																						String netdata1="";
																						String[] colorStr1=new String[] {"#33FF33","#333399","#33CCFF","#003366","#33FF33","#FF0033","#9900FF","#FFFF00","#0000FF","#A52A2A","#23f266"};
																							...
																							for (int i = 0; i < powervector.size(); i++) {
																										Interfacecollectdata interfacedata = (Interfacecollectdata) powervector
																											...
																											continue;	
																						flash.append("<value xid='").append(i).append("'>").append("闪存模块"+interfacedata.getSubentity()).append("</value>");
																						...
																						flash.append("</series><graphs><graph gid='0'>");
																									for (int i = 0; i < powervector.size(); i++) {
																										...
																										if (!"Flash".equals(interfacedata.getCategory().trim()))
																											continue;
																											flash.append("<value xid='").append(i).append("' color='").append(colorStr1[i]).append("'>"+interfacedata.getThevalue()).append("</value>");
