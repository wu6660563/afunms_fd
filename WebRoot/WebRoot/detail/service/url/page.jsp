																		...
																		<table width="100%" cellspacing="0" cellpadding="0"
																			...
																			<tr>
																				<td width="100%" align="center">
																					...
																					<script type="text/javascript">
																											var so = new SWFObject("<%=rootPath%>/flex/Web_pagesize_area.swf?id=<%=node.getNodeid()%>", "Web_pagesize_area", "400", "250", "8", "#ffffff");
...
setTimeout(function(){
  ...
  mainForm.action = "<%=rootPath%>/web.do?action=sychronizeData&id=<%=node.getNodeid()%>&flag=<%=flag_1%>&page=page";
  mainForm.submit();
 });    
});
</script>
