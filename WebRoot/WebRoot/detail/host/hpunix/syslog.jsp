...
<script language="JavaScript">
    ...
    */
    ...
    function query()
  {  
     mainForm.action = "<%=rootPath%>/hpunixData.do?action=getSyslogInfo";
     mainForm.submit();
  }
</script>
...
function setClass(){
    document.getElementById('hpunixDetailTitle-6').className='detail-data-title';
    document.getElementById('hpunixDetailTitle-6').onmouseover="this.className='detail-data-title'";
    document.getElementById('hpunixDetailTitle-6').onmouseout="this.className='detail-data-title'";
}
                                                                    ...
                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                        <tr>
                                                                            <td colspan=5 bgcolor="#ECECEC" height="28">
                                                                                ...
                                                                                %>
                                                                                <input type="button" name="submitss" value="登陆用户信息" onclick=openwin("showusersyslog",'<%=ipaddress%>') target="_blank">
                                                                                <%
                                                                                    }
                                                                                %>
                                                                            </td>
