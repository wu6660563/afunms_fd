...
function query()
   {  
     mainForm.action = "<%=rootPath%>/hpunixData.do?action=getEventInfo";
     mainForm.submit();
   }
</script>
...
function setClass(){
    document.getElementById('hpunixDetailTitle-9').className='detail-data-title';
    document.getElementById('hpunixDetailTitle-9').onmouseover="this.className='detail-data-title'";
    document.getElementById('hpunixDetailTitle-9').onmouseout="this.className='detail-data-title'";
}
