...
<script language="javascript">	
   ...
   function query()
  {  
     mainForm.action = "<%=rootPath%>/linuxData.do?action=getSyslogInfo";
     mainForm.submit();
  }
...
function setClass(){
	document.getElementById('liunxDetailTitle-6').className='detail-data-title';
	document.getElementById('liunxDetailTitle-6').onmouseover="this.className='detail-data-title'";
	document.getElementById('liunxDetailTitle-6').onmouseout="this.className='detail-data-title'";
}
																...
																<tr>
                                                                    ...
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;开始日期
																					...
																					<input type="button" name="submitss" value="登陆用户信息"
																						onclick="openwin('showusersyslog','<%=ipaddress%>')" target="_blank">
																					<%
																						}
																					%>
																				</td>
