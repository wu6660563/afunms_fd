...
{
    mainForm.action="<%=rootPath%>/linuxData.do?action=getProcessInfo&processName="+pro_name+"&layer="+layer;
    mainForm.submit();
}
function order(para,layer){
    ...
    %>
    mainForm.action = "<%=rootPath%>/linuxData.do?action=getProcessInfo&processName="+"<%=processName%>" + "&layer="+layer;
    
    <%
        } else {
    %>
     mainForm.action = "<%=rootPath%>/linuxData.do?action=getProcessInfo&layer="+layer;
    <%
        }
    %>
    mainForm.submit();
