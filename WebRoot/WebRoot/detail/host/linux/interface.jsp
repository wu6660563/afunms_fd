...
<%
	...
	String curSwapMemoryValue = (String) request
			.getAttribute("curSwapMemoryValue");
								...
								<td class="td-container-main-detail" width=85%>
									<table id="container-main-detail" class="container-main-detail">
										<tr>
											<td>
												<jsp:include
													page="/topology/includejsp/systeminfo_linux.jsp">
													...
													<jsp:param name="curSwapMemoryValue"
														value="<%=curSwapMemoryValue%>" />
																...
																<tr>
																	<td>
																		<table width="100%" border="0" cellpadding="0"
																			cellspacing="0">
																			<tr>
																				<td class="detail-data-body-title" rowspan="2"
																					style="height: 28px">
																					序号
																				</td>
																				<td class="detail-data-body-title" rowspan="2"
																				...
																				<td class="detail-data-body-title" colspan="2">
																					带宽利用率
																				</td>
																				<td class="detail-data-body-title" colspan="2">
																					流速
																			...
																			<%
																				for (int i = 0; i < ifvector.size(); i++) {
																					...
																					if (strs[0] != null && hash != null && hash.get(strs[0].trim()) != null) {
																						linkuse = (String) hash.get(strs[0].trim()).getLinkuse();
																					}
