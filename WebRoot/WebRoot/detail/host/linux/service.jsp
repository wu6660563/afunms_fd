...
<%@page import="com.afunms.temp.model.SoftwareNodeTemp"%>
...
<%
    ...
    List<ServiceNodeTemp> serviceNodeTempList = (List<ServiceNodeTemp>) request.getAttribute("serviceNodeTempList");  // 位置
...
function changeOrder(para){
  	location.href="<%=rootPath%>/linuxData.do?action=getInterfaceInfo&nodeid=<%=nodeid%>&type=<%=type%>&subtype=<%=subtype%>&ipaddress=<%=ipaddress%>&flag=<%=flag%>&orderflag="+para;
} 
...
function setClass(){
	document.getElementById('liunxDetailTitle-5').className='detail-data-title';
	document.getElementById('liunxDetailTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('liunxDetailTitle-5').onmouseout="this.className='detail-data-title'";
}
                      								                              ...
                      								                              <td colspan=2>
                      									                              <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
                                                                                          <tr>
                    			                                                              ...
                    			                                                              <td height="28" align="center" class="detail-data-body-title">服务名称</td>
                    				                                                          <td height="28" align="center" class="detail-data-body-title">当前状态</td> 
                                                                                              <td height="28" align="center" class="detail-data-body-title">采集时间</td>
                                                                                          </tr>
                                                                                            <%
                                                                                                if(serviceNodeTempList == null) {
                                                                                                    serviceNodeTempList = new ArrayList();
                                                                                                }
                                                                                                for(int m = 0; m < serviceNodeTempList.size(); m++){
                                                                                                    ServiceNodeTemp serviceNodeTemp = (ServiceNodeTemp) serviceNodeTempList.get(m);
                                                                                    				String serviceNodeTempName = serviceNodeTemp.getName();
                                                                                                    String serviceNodeTempInstate = serviceNodeTemp.getInstate();
                                                                                                    String serviceNodeTempCollecttime = serviceNodeTemp.getCollecttime();	
                                                                                                %>
                                                                                                <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>>
                                                                                                    <td height=25 class="detail-data-body-list" align="center">&nbsp;<font color='blue'><%=1 + m%></font></td>
                                                                                        		    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=serviceNodeTempName%></td> 
                                                                                        		    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=serviceNodeTempInstate%></td> 
                                                                                                    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=serviceNodeTempCollecttime%></td>      
                                                                                                </tr>
                                                                                                <%
                                                                                                    }
                                                                                                %>                        
