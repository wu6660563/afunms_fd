                        ...
                        <tr>
                            <td class="td-container-main-detail" width=85%>
                                <table id="container-main-detail" class="container-main-detail">
                                    <tr>
                                        <td> 
                                            <jsp:include page="/topology/includejsp/systeminfo_aix.jsp">
                                                                                ...
                                                                                <table width="100%" height="1" border="0" cellpadding="0" cellspacing="0">
                                                                                    ...
                                                                                    <tr> 
                                                                                        <td width="100%" align="center"> 
                                                                                            ...
                                                                                            <%
                                                                                                if(curDsikPerfInfo != null && curDsikPerfInfo.size()>0){ 
                                                                                                    
                                                                                                    for(int i=0;i<curDsikPerfInfo.size();i++){
                                                                                                        Hashtable diskperhash = (Hashtable)curDsikPerfInfo.get(i);
                                                                                            %>
                                                                                    ...
                                                                                    <tr> 
                                                                                        <td width="100%" align="center"> 
                                                                                            ...
                                                                                            <%
                                                                                                if(curDsikPerfIoInfo != null && curDsikPerfIoInfo.size()>0){
                                                                                                for(int i=0;i<curDsikPerfIoInfo.size();i++){
                                                                                                    Hashtable diskiohash = (Hashtable)curDsikPerfIoInfo.get(i);
                                                                                            %>
                                                                                                <tr height=28 <%=onmouseoverstyle%>> 
                                                                                    ...
                                                                                    <tr> 
                                                                                        <td width="100%" align="center"> 
                                                                                            ...
                                                                                            <%
                                                                                                if(curPagePerfInfo != null && curPagePerfInfo.size()>0){
                                                                                            %>
                                                                                                <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%> height=28> 
                                                                                                    <td  class="detail-data-body-list" align="center"><%=(String)curPagePerfInfo.get("re")%></td>
                                                                                                    <td  class="detail-data-body-list" align="center"><%=(String)curPagePerfInfo.get("pi")%></td>
                                                                                                    <td  class="detail-data-body-list" align="center"><%=(String)curPagePerfInfo.get("po")%></td>
                                                                                                    <td  class="detail-data-body-list" align="center"><%=(String)curPagePerfInfo.get("fr")%></td>
                                                                                                    <td  class="detail-data-body-list" align="center"><%=(String)curPagePerfInfo.get("sr")%></td>
                                                                                                    <td  class="detail-data-body-list" align="center"><%=(String)curPagePerfInfo.get("cy")%></td>
                                                                                                </tr>           
                                                                                            <% 
                                                                                                } 
                                                                                            %>
