                                                            ...
                                                            <table class="detail-data-body">
                                                                <tr>
																	<td align=center>
																			...
																			<tr>
																				<td align=center>
																					<table width="80%" border="0" cellpadding="0"
																						...
																						<%
																							if (curCPUConfigInfo != null && curCPUConfigInfo.size() > 0) {
																								for (int i = 0; i < curCPUConfigInfo.size(); i++) {
																									Nodecpuconfig cpuconfig = (Nodecpuconfig) curCPUConfigInfo
																											.get(i);
																						%>
																		...
																		<%
																			if (curNetmediaConfigInfo != null && curNetmediaConfigInfo.size() > 0) {
																				for (int i = 0; i < curNetmediaConfigInfo.size(); i++) {
																					Hashtable netmedia = (Hashtable) curNetmediaConfigInfo.get(i);
																		%>
																			<tr bgcolor="#FFFFFF" <%=onmouseoverstyle%> height=28>
