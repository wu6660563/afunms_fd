...
<%@page import="com.afunms.temp.model.StorageNodeTemp"%>
...
<%
    ...
    List<StorageNodeTemp> storageNodeTempList = (List<StorageNodeTemp>) request.getAttribute("storageNodeTempList");  // 位置
                      								                              ...
                      								                              <td colspan=2>
                      									                              <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
                                                                                          <tr>
                                                                                            ...
                                                                                            <%
                                                                                                if(storageNodeTempList == null) {
                                                                                                    storageNodeTempList = new ArrayList();
                                                                                                }
                                                                                                for(int m = 0; m < storageNodeTempList.size(); m++){
                                                                                                    StorageNodeTemp storageNodeTemp = (StorageNodeTemp) storageNodeTempList.get(m);
                                                                                    				String storageNodeTempStype = storageNodeTemp.getStype();
                                                                                                    String storageNodeTempName = storageNodeTemp.getName();     
                                                                                                    String storageNodeTempCap = storageNodeTemp.getCap();
                                                                                                %>
                                                                                                <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>>
                                                                                                    <td height=25 class="detail-data-body-list" align="center">&nbsp;<font color='blue'><%=1 + m%></font></td>
                                                                                        		    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=storageNodeTempStype%></td> 
                                                                                        		    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=storageNodeTempName%></td> 
                                                                                        		    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=storageNodeTempCap%></td>
                                                                                                </tr>
                                                                                                <%
                                                                                                    }
                                                                                                %>                        
