																																				...
																																				<table width="90%" cellpadding="0"
																																					...
																																					<tr height=15>
																																						<td valign=center align=right colspan=3>
																																							>><a href="javascript:void(window.open('<%=rootPath%>/monitor.do?action=memorydetail&id=<%=nodeid%>&ipaddress=<%=ipaddress%>','内存实时数据','top=100,left=300,height=600,width=660, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, status=no'))">实时</a> &nbsp;&nbsp;
																																						</td>
																																					</tr>
																																				</table>
																																			</td>
																		...
																		<table cellpadding="0" cellspacing="0" width=48%>
																			<tr>
																				<td width="100%" align=center>
																					...
																					<script type="text/javascript">
																					var so = new SWFObject("<%=rootPath%>/flex/Area_Disk.swf?ipadress=<%=ipaddress%>", "Area_Disk", "346", "360", "8", "#ffffff");
																																						...
																																						<div id="diskUtil">
																																							...
																																							<script type="text/javascript">
		                                                                                                                                                           ...
		                                                                                                                                                           var so = new SWFObject("<%=rootPath%>/amchart/amcolumn.swf", "amcolumn", "480", "210", "8", "#FFFFFF");
	                                                                                                                                                                 ...
	                                                                                                                                                                 //	so.addVariable("data_file",  escape("<%=rootPath%>/amcharts_data/memorypercent_data.xml"));
	                                                                                                                                                                   so.addVariable("chart_data", "<%=curDayAmWindowsDiskChartInfo%>");
		                                                                                                                                                               so.addVariable("preloader_color", "#999999");
		                                                                                                                                                               so.write("diskUtil");
	                                                                                                                                                        </script>
																																						</td>
																																					...
																																					<tr>
																																						<td>
																																							<table cellpadding="0"
																																								...
																																								<tr>
																																									<%
																																										Hashtable diskhash1 = (Hashtable) (curDayDiskValueHashtable.get(new Integer(i)));
