						...
						<tr>
							<td class="td-container-main-detail" width=85%>
								<table id="container-main-detail" class="container-main-detail">
									<tr>
										<td> 
											<jsp:include page="/topology/includejsp/systeminfo_windows.jsp">
                                                 ...
                                                 <jsp:param name="curVirtualMemoryValue" value="<%= curVirtualMemoryValue %>"/>
                                                                                          ...
                                                                                          <tr>
                                                                                            ...
                                                                                            <%
                                                                                                ...
                                                                                                for(int m = 0; m < serviceNodeTempList.size(); m++){
                                                                                                    ...
                                                                                                    String serviceNodeTempOpstate = serviceNodeTemp.getOpstate();               
                                                                                                    String serviceNodeTempUninst = serviceNodeTemp.getUninst();
                                                                                                    String serviceNodeTempPaused = serviceNodeTemp.getPaused();	
                                                                                                %>
                                                                                                <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>>
                                                                                        		    ...
                                                                                        		    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=serviceNodeTempOpstate%></td>
                                                                                                    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=serviceNodeTempUninst%></td>      
                                                                                                    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=serviceNodeTempPaused%></td>      
                                                                                                </tr>
                                                                                                <%
                                                                                                    }
                                                                                                %>                        
