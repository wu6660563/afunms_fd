...
<%
    ...
    List<DeviceNodeTemp> deviceNodeTempList = (List<DeviceNodeTemp>) request.getAttribute("deviceNodeTempList");  // 位置
                      								                              ...
                      								                              <td colspan=2>
                      									                              <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
                                                                                          <tr>
                                                                                            ...
                                                                                            <%
                                                                                                if(deviceNodeTempList == null) {
                                                                                                    deviceNodeTempList = new ArrayList();
                                                                                                }
                                                                                                for(int m = 0; m < deviceNodeTempList.size(); m++){
                                                                                                    DeviceNodeTemp deviceNodeTemp = (DeviceNodeTemp) deviceNodeTempList.get(m);
                                                                                    				String deviceNodeTempDtype = deviceNodeTemp.getDtype();
                                                                                                    String deviceNodeTempName = deviceNodeTemp.getName();     
                                                                                                    String deviceNodeTempStatus = deviceNodeTemp.getStatus();
                                                                                                %>
                                                                                                <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>>
                                                                                                    <td height=25 class="detail-data-body-list" align="center">&nbsp;<font color='blue'><%=1 + m%></font></td>
                                                                                        		    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=deviceNodeTempDtype%></td> 
                                                                                        		    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=deviceNodeTempName%></td> 
                                                                                        		    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=deviceNodeTempStatus%></td>
                                                                                                </tr>
                                                                                                <%
                                                                                                    }
                                                                                                %>                        
