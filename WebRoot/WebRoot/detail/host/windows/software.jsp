...
<%
    ...
    List<SoftwareNodeTemp> softwareNodeTempList = (List<SoftwareNodeTemp>) request.getAttribute("softwareNodeTempList");  // 位置
					                                                          ...
					                                                          <tr bgcolor="DEEBF7"> 
                      								                              <td colspan=2>
                      									                              <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
                                                                                            ...
                                                                                            <%
                                                                                                if(softwareNodeTempList == null) {
                                                                                                    softwareNodeTempList = new Vector();
                                                                                                }
                                                                                                for(int m = 0; m < softwareNodeTempList.size(); m++){
                                                                                                  SoftwareNodeTemp softwareNodeTemp = (SoftwareNodeTemp) softwareNodeTempList.get(m);
                                                                                    					String softwareNodeTempName = softwareNodeTemp.getName();
                                                                                    					String softwareNodeTempSwid = softwareNodeTemp.getSwid();
                                                                                    					String softwareNodeTempType = softwareNodeTemp.getType();				
                                                                                    					String softwareNodeTempInsdate = softwareNodeTemp.getInsdate();
                                                                                    					
                                                                                                %>
                                                                                                <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>>
                                                                                                    <td height=25 class="detail-data-body-list" align="center">&nbsp;<font color='blue'><%=1 + m%></font></td>
                                                                                        		    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=softwareNodeTempName%></td> 
                                                                                        		    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=softwareNodeTempType%></td> 
                                                                                        		    <td height=25 class="detail-data-body-list" align="center">&nbsp;<%=softwareNodeTempInsdate%></td>		
                                                                                                </tr>
                                                                                                <%
                                                                                                    }
                                                                                                %>                        
