...
function setClass(){
    document.getElementById('tru64DetailTitle-0').className='detail-data-title';
    document.getElementById('tru64DetailTitle-0').onmouseover="this.className='detail-data-title'";
    document.getElementById('tru64DetailTitle-0').onmouseout="this.className='detail-data-title'";
}
                                                                ...
                                                                <tr>
                                                                  ...
                                                                  <%  if(!curCPUDetailAmChartInfo.equals("0")){%>
                                                                       var so = new SWFObject("<%=rootPath%>/amchart/amcolumn.swf", "amcolumn", "485", "210", "8", "#FFFFFF");
                                                                           ...
                                                                           so.addVariable("preloader_color", "#999999");
                                                                           so.write("tru64CpuDetail");
                                                                           <%}else{%>
                                                                           var _div=document.getElementById("tru64CpuDetail");
