...
<script language="JavaScript">
    ...
    */
    ...
    function query()
  {  
     mainForm.action = "<%=rootPath%>/tru64Data.do?action=getSyslogInfo";
     mainForm.submit();
  }
</script>
...
function setClass(){
    document.getElementById('tru64DetailTitle-6').className='detail-data-title';
    document.getElementById('tru64DetailTitle-6').onmouseover="this.className='detail-data-title'";
    document.getElementById('tru64DetailTitle-6').onmouseout="this.className='detail-data-title'";
}
