...
<%
    ...
    String curPingValue = (String) request.getAttribute("curPingImage");
    ...
    String curMemoryValue = (String) request
            .getAttribute("curMemoryValue");
    ...
    Hashtable<String, Portconfig> portconfigHashtable = (Hashtable<String, Portconfig>) request.getAttribute("portconfigHashtable");

    String importantButton = "";
    String allPortButton = "";
    if ("0".equals(important)) {
        allPortButton = "disabled=\"disabled\"";
    } else {
...
function submitForm() {
    mainForm.action = "<%=rootPath%>/tru64Data.do?action=getInterfaceInfo";
    mainForm.submit();
}
...
function setClass(){
	document.getElementById('tru64DetailTitle-1').className='detail-data-title';
	document.getElementById('tru64DetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('tru64DetailTitle-1').onmouseout="this.className='detail-data-title'";
}
...
function refer(action){
    ...
    <body id="body" class="body" onload="initmenu();">
        ...
        <form id="mainForm" method="post" name="mainForm">
            ...
            <input type=hidden name="orderflag" id="orderflag" value="<%=orderflag%>">
            <input type=hidden name="nodeid" id="nodeid" value="<%=nodeid%>">
            <input type=hidden name="type" id="type" value="<%=type%>">
            <input type=hidden name="subtype" id="subtype" value="<%=subtype%>">
            <input type=hidden name="important" id="important" value="<%=important%>">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%">
                                                                        	<!-- 
                                                                            <tr>
                                                                                <td colspan="11" class="detail-data-body-title" >
                                                                                    <table>
                                                                                        <tr>
                                                                                            <td style="text-align: right;height: 28px;">
                                                                                            	
                                                                                                <input type="button" value="关键端口" onclick="changePort(1)" <//%=importantButton%>>
                                                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                                <input type="button" value="所有端口" onclick="changePort(0)" <//%=allPortButton%>>
                                                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                            ...
                                                                            <tr >
                                                                                ...
                                                                                <td class="detail-data-body-title" rowspan="2" width="9%">端口IP/MAC</td>
                                                                            ...
                                                                            <tr>
                                                                                <td class="detail-data-body-title" width="12%" style="height: 28px">
                                                                                    <input type=button name="button3" value="出口带宽" onclick="changeOrder('OutBandwidthUtilHdxPerc')">
                                                                                </td>
                                                                                <td class="detail-data-body-title" width="12%" >
                                                                                    <input type=button name="button4" value="入口带宽" onclick="changeOrder('InBandwidthUtilHdxPerc')">
                                                                                </td>
                                                                                <td class="detail-data-body-title" width="12%" >
                                                                                    <input type=button name="button3" value="出口流速" onclick="changeOrder('OutBandwidthUtilHdx')">
                                                                                </td>
                                                                                <td class="detail-data-body-title" width="12%" >
                                                                                    <input type=button name="button4" value="入口流速" onclick="changeOrder('InBandwidthUtilHdx')">
                                                                                </td>
                                                                            </tr>
                                                                            <%
                                                                                for (int i = 0; i < ifvector.size(); i++) {
                                                                                    ...
                                                                                    String linkuse="";
                                                                                    if(strs[0]!=null&&portconfigHashtable!=null&&portconfigHashtable.get(strs[0].trim())!=null){
                                                                                    	linkuse = portconfigHashtable.get(strs[0].trim()).getLinkuse();
                                                                                    }
                                                                                    //String linkuse = portconfigHashtable.get(strs[0].trim()).getLinkuse();
                                                                                    String url = rootPath + "/resource/image/topo/testing.gif";
                                                                                    if ("up".equalsIgnoreCase(strs[3])) {
                                                                                       url =rootPath+"/resource/image/topo/up.gif";
                                                                                    } else if ("down".equalsIgnoreCase(strs[3])) {
                                                                                       url =rootPath+"/resource/image/topo/down.gif";
                                                                                    }
                                                                            %>
                                                                            <tr <%=onmouseoverstyle%> style="height: 28px">
                                                                                <td class="detail-data-body-list" style="height: 28px"><%=i + 1%></td>
                                                                                ...
                                                                                <td width="5%" class="detail-data-body-list">
                                                                                    <img src="<%=rootPath%>/resource/image/status.gif" border="0" width=15 oncontextmenu=showMenu('2','<%=strs[0]%>','<%=strs[1].replaceAll(" ", "-")%>')>
                                                                                </td>
                                                                            </tr>
                                                                            <%
                                                                                }
