...
<%
    ...
    List<RouterNodeTemp> routerNodeTempList = (List<RouterNodeTemp>) request.getAttribute("routerNodeTempList");  // 位置
%> 
<html>
<head>
...
function setClass(){
	document.getElementById('venusDetailTitle-4').className='detail-data-title';
	document.getElementById('venusDetailTitle-4').onmouseover="this.className='detail-data-title'";
	document.getElementById('venusDetailTitle-4').onmouseout="this.className='detail-data-title'";
}
														...
														<td>
															<table class="detail-data-body">
                                                                <tr>
                                                                    ...
                                                                    <td align="center" class="body-data-title">目标地址</td>
                                                                    <td align="center" class="body-data-title">下一跳</td>
                                                                    <td align="center" class="body-data-title">路由类型</td>
                                                                    <td align="center" class="body-data-title">路由协议</td>
                                                                    <td align="center" class="body-data-title">子网掩码</td>
