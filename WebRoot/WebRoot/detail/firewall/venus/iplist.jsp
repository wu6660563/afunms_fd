...
function setClass(){
	document.getElementById('venusDetailTitle-5').className='detail-data-title';
	document.getElementById('venusDetailTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('venusDetailTitle-5').onmouseout="this.className='detail-data-title'";
}
