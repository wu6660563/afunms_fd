...
<%
    ...
    List<IpMac> ipMacList = (List<IpMac>) request.getAttribute("ipMacList");  // 位置
%> 
<html>
<head>
...
function changeOrder(para){
  	location.href="<%=rootPath%>/venusData.do?action=getInterfaceInfo&nodeid=<%=nodeid%>&type=<%=type%>&subtype=<%=subtype%>&ipaddress=<%=ipaddress%>&flag=<%=flag%>&orderflag="+para;
} 
...
function setClass(){
	document.getElementById('venusDetailTitle-2').className='detail-data-title';
	document.getElementById('venusDetailTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('venusDetailTitle-2').onmouseout="this.className='detail-data-title'";
}
														...
														<td>
															<table class="detail-data-body">
                                                                <tr style="height: 28">
                                                                    ...
                                                                    <td align="center" class="body-data-title">采集时间</td>
                                                                </tr>
                                                                <%
                                                                    if (ipMacList != null || ipMacList.size() > 0) {
                                                                        ...
                                                                        for (IpMac ipMac : ipMacList) {
                                                                            i++;
                                                                            String ipMacIfindex = ipMac.getIfindex();
                                                                            String ipMacIpaddress = ipMac.getIpaddress();
                                                                            String ipMacMac = ipMac.getMac();
                                                                            Calendar calendar = ipMac.getCollecttime();
                                                                            String ipMacCollectTime =  simpleDateFormat.format(calendar.getTime());
                                                                        %>
                                                                        
                                                                <tr style=bgcolor:#FFFFF" bgcolor="#FFFFFF" height=28 <%=onmouseoverstyle%>>
                                                                    <td align="center" class="body-data-list"><%=String.valueOf(i)%></td>
                                                                    <td align="center" class="body-data-list"><%=ipMacIfindex %></td>
                                                                    <td align="center" class="body-data-list"><%=ipMacIpaddress %></td>
                                                                    <td align="center" class="body-data-list"><%=ipMacMac%></td>
                                                                    <td align="center" class="body-data-list"><%=ipMacCollectTime%></td>
                                                                </tr>  
