...
function setClass(){
	document.getElementById('venusDetailTitle-1').className='detail-data-title';
	document.getElementById('venusDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('venusDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
