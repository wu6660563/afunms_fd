...
<script language="JavaScript">
	...
	*/
    ...
    function query()
   {  
     mainForm.action = "<%=rootPath%>/venusData.do?action=getEventInfo";
     mainForm.submit();
   }
...
function setClass(){
	document.getElementById('venusDetailTitle-7').className='detail-data-title';
	document.getElementById('venusDetailTitle-7').onmouseover="this.className='detail-data-title'";
	document.getElementById('venusDetailTitle-7').onmouseout="this.className='detail-data-title'";
}
