...
function submitForm() {
    mainForm.action = "<%=rootPath%>/venusData.do?action=getInterfaceInfo";
    mainForm.submit();
}
...
function setClass(){
	document.getElementById('venusDetailTitle-0').className='detail-data-title';
	document.getElementById('venusDetailTitle-0').onmouseover="this.className='detail-data-title'";
	document.getElementById('venusDetailTitle-0').onmouseout="this.className='detail-data-title'";
}
                                                                        ...
                                                                        <table width="100%">
                                                                            ...
                                                                            <%
                                                                                for (int i = 0; i < ifvector.size(); i++) {
                                                                                    ...
                                                                                    if(strs[0]!=null&&portconfigHashtable.get(strs[0].trim())!=null){
