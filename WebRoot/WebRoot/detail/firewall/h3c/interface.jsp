...
function submitForm() {
    mainForm.action = "<%=rootPath%>/h3cfirewallData.do?action=getInterfaceInfo";
    mainForm.submit();
}
...
function setClass(){
	document.getElementById('h3cfirewallDetailTitle-0').className='detail-data-title';
	document.getElementById('h3cfirewallDetailTitle-0').onmouseover="this.className='detail-data-title'";
	document.getElementById('h3cfirewallDetailTitle-0').onmouseout="this.className='detail-data-title'";
}
                                                                        ...
                                                                        <table width="100%">
                                                                            ...
                                                                            <%
                                                                                for (int i = 0; i < ifvector.size(); i++) {
                                                                                    ...
                                                                                    String linkuse = "";
                                                                                    if(portconfigHashtable.get(strs[0].trim())!=null){
