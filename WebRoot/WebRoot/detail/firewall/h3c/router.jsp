...
function setClass(){
	document.getElementById('h3cfirewallDetailTitle-4').className='detail-data-title';
	document.getElementById('h3cfirewallDetailTitle-4').onmouseover="this.className='detail-data-title'";
	document.getElementById('h3cfirewallDetailTitle-4').onmouseout="this.className='detail-data-title'";
}
