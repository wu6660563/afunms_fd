...
<script language="JavaScript">
	...
	*/
    ...
    function query()
   {  
     mainForm.action = "<%=rootPath%>/h3cfirewallData.do?action=getEventInfo";
     mainForm.submit();
   }
...
function setClass(){
	document.getElementById('h3cfirewallDetailTitle-7').className='detail-data-title';
	document.getElementById('h3cfirewallDetailTitle-7').onmouseover="this.className='detail-data-title'";
	document.getElementById('h3cfirewallDetailTitle-7').onmouseout="this.className='detail-data-title'";
}
