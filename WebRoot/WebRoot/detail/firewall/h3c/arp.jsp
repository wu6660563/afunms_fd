...
function setClass(){
	document.getElementById('h3cfirewallDetailTitle-2').className='detail-data-title';
	document.getElementById('h3cfirewallDetailTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('h3cfirewallDetailTitle-2').onmouseout="this.className='detail-data-title'";
}
