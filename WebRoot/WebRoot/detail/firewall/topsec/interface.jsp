...
function submitForm() {
    mainForm.action = "<%=rootPath%>/topsecData.do?action=getInterfaceInfo";
    mainForm.submit();
}
...
function setClass(){
	document.getElementById('topsecDetailTitle-0').className='detail-data-title';
	document.getElementById('topsecDetailTitle-0').onmouseover="this.className='detail-data-title'";
	document.getElementById('topsecDetailTitle-0').onmouseout="this.className='detail-data-title'";
}
                                                            ...
                                                            <table class="detail-data-body">
                                                                <tr>
                                                                    <td>
                                                                        <table width="100%">
                                                                            <tr>
                                                                                <td colspan="12" class="detail-data-body-title" >
                                                                                    <table>
                                                                                        <tr>
