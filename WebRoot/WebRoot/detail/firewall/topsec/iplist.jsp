...
function setClass(){
	document.getElementById('topsecDetailTitle-5').className='detail-data-title';
	document.getElementById('topsecDetailTitle-5').onmouseover="this.className='detail-data-title'";
	document.getElementById('topsecDetailTitle-5').onmouseout="this.className='detail-data-title'";
}
