...
function setClass(){
	document.getElementById('topsecDetailTitle-2').className='detail-data-title';
	document.getElementById('topsecDetailTitle-2').onmouseover="this.className='detail-data-title'";
	document.getElementById('topsecDetailTitle-2').onmouseout="this.className='detail-data-title'";
}
