...
function setClass(){
	document.getElementById('topsecDetailTitle-1').className='detail-data-title';
	document.getElementById('topsecDetailTitle-1').onmouseover="this.className='detail-data-title'";
	document.getElementById('topsecDetailTitle-1').onmouseout="this.className='detail-data-title'";
}
