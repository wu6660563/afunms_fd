...
<script language="JavaScript">
	...
	*/
    ...
    function query()
   {  
     mainForm.action = "<%=rootPath%>/topsecData.do?action=getEventInfo";
     mainForm.submit();
   }
...
function setClass(){
	document.getElementById('topsecDetailTitle-7').className='detail-data-title';
	document.getElementById('topsecDetailTitle-7').onmouseover="this.className='detail-data-title'";
	document.getElementById('topsecDetailTitle-7').onmouseout="this.className='detail-data-title'";
}
