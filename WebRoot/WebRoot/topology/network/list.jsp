...
String actionlist=(String)request.getAttribute("actionlist");
  JspPage jp = (JspPage)request.getAttribute("page");
    ...
    RoleOperationPermissionService  roleOperationPermissionService = RoleOperationPermissionService.getInstance(user, OperationPermissionService.getNodeOperationPermission());
					        									            ...
					        									            <tr <%=onmouseoverstyle%>>
					        													...
					        													<td align="center" class="body-data-list"><%=vo.getType()%></td>
					        													   <%
					        													       ...
					        													       //linux信息查找nms_nodeconfig表
					        													       if(Constant.TYPE_HOST_SUBTYPE_LINUX.equalsIgnoreCase(vo.getType())){
												                                 			NodeconfigDao dao = new NodeconfigDao();
								        													Nodeconfig nodeConfig = dao.getByNodeID(String.valueOf(vo.getId()));
								        													if(nodeConfig!=null&&nodeConfig.getCSDVersion()!=null){
								        														sysdescrforshow = nodeConfig.getCSDVersion();
								        														sysdescr = nodeConfig.getCSDVersion();
								        													}
												                                 		}
                  									                                   if(sysdescr!=null&&!"".equals(sysdescr)){
													                                 		...
													                                 		//其他的没有系统信息的
													                                 		if("".equals(sysdescrforshow.trim())){
													                                 			sysdescrforshow = vo.getType();
													                                 		}
													                                 	}
													                               %>
