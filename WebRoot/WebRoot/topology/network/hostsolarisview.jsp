   ...
   // Hashtable Disk = new Hashtable();
    ...
    try{
		...
		try{
    			...
    			Disk = hostlastmanager.getDisk(host.getIpAddress(),"Disk",starttime,endtime);
    		}catch(Exception e){
    			e.printStackTrace();
    		}
    	}
     ...
     new PollMonitorManager().draw_column(Disk,"",newip+"disk",750,150);
	...
	cbp.createResponseTimePic(picip,responsevalue.replaceAll("%",""),maxresponse.replaceAll("%",""),avgresponse.replaceAll("%",""));
	//amchar 连通率
                      ...
                      <table cellpadding="0" cellspacing="0" width=48% align=center>
										...
										<tr>
																	<td width=100% align=center valign=top>
																		<table cellpadding="1" cellspacing="1" style="align:center;width:316" bgcolor="#FFFFFF">
																			<tr bgcolor="#FFFFFF">
                  ...
                  %>          
                    ...
                    <br>
                      <table cellpadding="0" cellspacing="0" width=48% align=center>
										...
										<tr>
																		<td width=100% align=center>
																		<table cellpadding="0" cellspacing="1" style="align:center;width:316" bgcolor="#FFFFFF">
																			<tr bgcolor="#FFFFFF">
																				<td height="29" class="detail-data-body-title" style="height:29">名称</td>
																				<td class="detail-data-body-title" style="height:29">当前</td>
                  ...
                  <br>
                      <table cellpadding="0" cellspacing="0" width=48% align=center>
										...
										<tr>
																	...
																	<table width="90%" cellpadding="0" cellspacing="0" style="align:center;valign:top;width:316">
																...
																<td align=center colspan=2 style="width:95%">
																    	<br>
                   															<table style="width:95%" border=1>
																				...
																				<table width="95%">
														                					<tr>
																	                			<td align="left" height=30 bgcolor="#ECECEC">&nbsp;<B>磁盘利用率</B></td>											   
																					</tr>
															       					</table>
														       					</td>
														       				</tr>
				                   															...
				                   															<%
																						                      ...
																						                      String dataStr="";
				                   															                if (Disk != null && Disk.size() > 0) {
																						                        ...
																						                        String[] colorStr=new String[] {"#33FF33","#FF0033","#9900FF","#FFFF00","#33CCFF","#003366","#33FF33","#FF0033","#9900FF","#FFFF00","#333399","#0000FF","#A52A2A","#23f266"};
																						                        sb.append("<chart><series>");
																						                        if(diskname!=null){
																						                        for(int k=0;k<diskname.length;k++){
																													sb.append("<value xid='").append(k).append("'>").append(diskname[k]).append("</value>");
																													...
																													int perInt=Math.round(Float.parseFloat(percent[i].replaceAll("%","")));
				                    															...
				                    															<tr>
																            		    			...
																            		    			<br>
																										...
																										<div class="loading-indicator">
																											...
																											<tr>
																												<td class="detail-data-body-title" style="height:29">磁盘名</td>
																												<td class="detail-data-body-title" style="height:29">总容量</td>
																												<td class="detail-data-body-title" style="height:29">已用容量</td>
																												<td class="detail-data-body-title" style="height:29">利用率</td>
																											</tr>
																														<%
																														if (Disk != null && Disk.size() > 0) {
																															// 写磁盘
																													    ...
																													    %>
																													            <tr>
																																	...
																																	String name = (String) diskhash.get("name");
																																	%>
																														            <td class="detail-data-body-list" height="29"><%=name %></td>
																																	<%
																																	...
																																	%>
																														            <td class="detail-data-body-list" height="29"><%=value %></td>
																														            <%  
																													                }
																													                %>
																													            </tr>
