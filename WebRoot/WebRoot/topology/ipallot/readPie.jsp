...
String tmpOnline = (String)request.getParameter("tmpOnline");
String tmpOther = (String)request.getParameter("tmpOther");
              							...
              							<tr> 
                							<td width="100%" > 
												...
												<script type="text/javascript">
													var so = new SWFObject("<%=rootPath%>/flex/Ip_Pie.swf?tmp=<%=tmp%>&tmpOnline=<%=tmpOnline%>&tmpOther=<%=tmpOther%>&title=<%=title%>", "Ip_Pie", "390", "340", "8", "#ffffff");
