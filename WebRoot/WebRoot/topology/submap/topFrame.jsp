  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" >
	  <tr>
		...
		<td width="100" style="display: <%=updateOperationDisable%>;"><input type="button" name="editmap" class="button_editmap_out" onmouseover="javascript:buttonEditMapOver();" onmouseout="javascript:buttonEditMapOut();" onclick="javascript:editSubMap();" value="拓扑图属性" title="拓扑图属性"/></td>
		<td width="100" style="display: <%=deleteOperationDisable%>;"><input type="button" name="delmap" class="button_delmap_out" onmouseover="javascript:buttonDelMapOver();" onmouseout="javascript:buttonDelMapOut();" onclick="javascript:deleteSubMap();" value="删除拓扑图" title="删除拓扑图"/></td>
		...
		<td width="100" style="display: inline;"><input type="button" name="loadlink" class="button_create3_out" onmouseover="javascript:buttonCreate3Over();" onmouseout="javascript:buttonCreate3Out();" onclick="javascript:loadLink();" value="导入实体链路" title="导入实体链路"/></td>
		<td width="56">
	<%if (fullscreen.equals("0")) {%>
    <!-- 
