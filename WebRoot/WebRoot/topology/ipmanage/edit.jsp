...
<%  
   ...
   IpManageBasicVo vo = (IpManageBasicVo) request.getAttribute("vo");
...
setTimeout(function(){
 ...
 Ext.get("process").on("click",function(){
        ...
        mainForm.action = "<%=rootPath%>/ipmanage.do?action=edit";
        mainForm.submit();
 });	
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title">&nbsp;资源 >> IP/MAC资源 >> IP地址管理</td>
				        								...
				        								<table id="detail-content-body" class="detail-content-body">
				        									<tr>
				        										<td>
																		...
																		<TD nowrap width="40%">&nbsp;
																			<input type="text" name="ipaddress" maxlength="50" size="20" style="width:150px;" class="formStyle" value="<%=vo.getIpaddress()%>">
																		<TD nowrap align="right" height="24" width="10%">MAC地址&nbsp;</TD>				
																		<TD nowrap width="40%">&nbsp;
																			<input type="text" name="mac" maxlength="50" size="20" style="width:150px;" class="formStyle" value="<%=vo.getMac()%>">
																		</TD>															
																		</tr>
																	<tr style="background-color: #ECECEC;">						
																		<TD nowrap align="right" height="24" width="10%">是否管理&nbsp;</TD>				
																		<TD nowrap width="40%">&nbsp;
																			<select name="ifmanage" class="formStyle" style="width:150px;">
																				<option value="1" <%if("1".equals(vo.getIfmanage())){out.print("selected='selected'");}%>>是</option>
																				<option value="0" <%if("0".equals(vo.getIfmanage())){out.print("selected='selected'");}%>>否</option>
																			</select>
																		</TD>
																		<td nowrap align="right" height="24" width="10%">用途&nbsp;</td>
																		<td nowrap width="40%">&nbsp;
																			<input type="text" name="bak" size="20" style="width:150px;" class="formStyle" value="<%=vo.getBak()%>">
																		</td>
																	</tr>
																	<tr>
