...
function save() {
	 mainForm.action = "<%=rootPath%>/ipmanage.do?action=add";
     mainForm.submit();
}
				        								...
				        								<table id="detail-content-body" class="detail-content-body">
				        									<tr>
				        										<td>
																		...
																		<TD nowrap width="40%">&nbsp;
																			<input type="text" name="mac" maxlength="50" size="20" style="width:150px;" class="formStyle">
																		</TD>															
																		</tr>
																	<tr style="background-color: #ECECEC;">						
																		...
																		<td nowrap width="40%">&nbsp;
																			<input type="text" name="bak" size="20" style="width:150px;" class="formStyle">
																		</td>
																	</tr>
																	<tr>
