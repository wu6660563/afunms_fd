											...
											<td>
												<table id="content-header" class="content-header">
								                	<tr>
									                	...
									                	<td class="content-title"> 资源 >> 性能监视 >> 性能指标 >> 性能指标选择 </td>
							        								...
							        								if("multi".equals(jspFlag)){
							        									...
							        									if(gatherIndicatorsList != null && gatherIndicatorsList.size() > 0) {
    							        									for(int i = 0; i < gatherIndicatorsList.size(); i++){
    							        										...
    							        										%>
    							        										<tr>
    							        											<td class="body-data-list" width=30% align=right><input type=checkbox name="checkbox" value="<%=gatherIndicators.getId()%>">&nbsp;</td>
