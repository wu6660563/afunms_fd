								...
								<td width="50%" align="left" valign="top">
									<table cellpadding="0" cellspacing="0" width=100% align=center>
										<tr>
											...
											<td width=70%>
											<!-- <//%=host.getAlias()%>[<a href="<//%=rootPath%>/network.do?action=ready_editalias&id=<//%=tmp%>&ipaddress=<//%=host.getIpAddress()%>"><img src="<//%=rootPath%>/resource/image/editicon.gif" border=0>修改</a>] -->
