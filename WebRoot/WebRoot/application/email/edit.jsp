				        										...
				        										<td>
																		...
																		<TBODY>
																			<tr>						
																				...
																				<TD nowrap align="right" height="24" width="10%"><font color="red">*&nbsp;</font>邮件地址&nbsp;</TD>				
																				<TD nowrap width="40%">&nbsp;
																					<input type="text" id="address" name="address" maxlength="50" size="20" class="formStyle" value=<%=vo.getAddress()%>>
																				</TD>
																			</tr>
