...
<%  
   ...
   ApplicationNode applicationNode = (ApplicationNode)request.getAttribute("applicationNode");

	BusinessDao bussdao = new BusinessDao();
	List allbuss = bussdao.loadAll();
	String bid = applicationNode.getBid();
  	String id[] = bid.split(",");
...
function save() {
	...
	if(uniquekey.replace(/(^\s*)|(\s*$)/g,'') == ""){
	 ...
	 mainForm.action = "<%=rootPath%>/applicationnode.do?action=update";
        mainForm.submit();
}
													...
													<td>
														<table id="add-content-header" class="add-content-header">
										                	<tr>
											                	...
											                	<td class="add-content-title"> 应用 >> 应用系统 >> 修改应用系统信息 </td>
				        								...
				        								<table id="detail-content-body" class="detail-content-body">
				        									<tr>
				        										<td>
																	...
																	<TD nowrap width="40%">&nbsp;
																		<input type="hidden" name="id" value="<%=applicationNode.getId() %>" >
																		<input type="text" name="ipaddress" maxlength="50" size="20" style="width:150px;" class="formStyle" value="<%=applicationNode.getIpAddress() %>" >
																	<TD nowrap align="right" height="24" width="10%">别名&nbsp;</TD>				
																	<TD nowrap width="40%">&nbsp;
																		<input type="text" name="name" maxlength="50" size="20" style="width:150px;" class="formStyle" value="<%=applicationNode.getName() %>" >
																		<font color="red">&nbsp;*</font></TD>															
																	</tr>
																		     <tr >						
																	<TD nowrap align="right" height="24" width="10%">类型&nbsp;</TD>				
																	<TD nowrap width="40%">&nbsp;
																		<input type="text" name="type" maxlength="50" size="20" style="width:150px;" class="formStyle"  readonly="readonly" value="<%=applicationNode.getType() %>">
																	<TD nowrap align="right" height="24" width="10%">子类型&nbsp;</TD>				
																	<TD nowrap width="40%">&nbsp;
																		<input type="text" name="subtype" maxlength="50" size="20" style="width:150px;" class="formStyle" readonly="readonly" value="<%=applicationNode.getSubtype() %>">
																		</TD>															
																	</tr>
																		     <tr style="background-color: #ECECEC;" >						
																	<TD nowrap align="right" height="24" width="10%">关键标识&nbsp;</TD>				
																	<TD nowrap width="40%">&nbsp;
																		<input type="text" name="uniquekey" maxlength="50" size="20" style="width:150px;" class="formStyle" value="<%=applicationNode.getUniqueKey() %>">
																		<font color="red">&nbsp;*</font>
																	<TD nowrap align="right" height="24" width="10%">描述&nbsp;</TD>				
																	<TD nowrap width="40%">&nbsp;
																		<input type="text" name="descr" maxlength="50" size="20" style="width:150px;" class="formStyle" value="<%=applicationNode.getDescr() %>">
																		</TD>															
																	</tr>
