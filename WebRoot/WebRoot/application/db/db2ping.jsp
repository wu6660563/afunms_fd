																		...
																		<table cellpadding="0" cellspacing="0" width=98%>
																			<tr>
																				<td width="100%">
																					...
																					<script type="text/javascript">
																						var so = new SWFObject("<%=rootPath%>/flex/Oracle_Ping.swf?ipadress=<%=vo.getIpAddress()%>&category=DB2Ping", "Oracle_Ping", "346", "250", "8", "#ffffff");
																		...
																		<table cellpadding="0" cellspacing="0" width=98%>
																			<tr>
																				<td width="100%">
																					...
																					<script type="text/javascript">
																						var so = new SWFObject("<%=rootPath%>/flex/Column_Db2_TableSpace.swf?ipadress=<%=vo.getIpAddress()%>&port=<%=vo.getPort()%>&name=<%=vo.getDbName()%>&user=<%=vo.getUser()%>&pwd=<%=vo.getPassword()%>", "Column_Db2_TableSpace", "346", "250", "8", "#ffffff");
