...
/********************获取ASM信息************************/
List<Map<String,Object>> listGroupInfo = (List<Map<String,Object>>)request.getAttribute("listGroupInfo");
List<Map<String,Object>> listUnitsize = (List<Map<String,Object>>)request.getAttribute("listUnitsize");
List<Map<String,Object>> listFailgroup = (List<Map<String,Object>>)request.getAttribute("listFailgroup");
																	...
																	<!--   ///////////////// asm 磁盘组信息显示模块 /////////////////////  -->
																						...
																						<td>
																							<table width="96%" align="center" border="0"
																								...
																								<tr bgcolor="#ECECEC" height="28" >
																									...
																									<td align=center colspan="3" class="application-detail-data-body-title">
																										ASM磁盘组的信息和状态
																									</td>
																								...
																								<%
																									if (listGroupInfo != null) {
																									
																										 for (int i = 0; i < listGroupInfo.size(); i++) {
																									            Map<String, Object> row = new HashMap<String, Object>();
																									            row = listGroupInfo.get(i);
																									            String group_number = (String) row.get("group_number");
																					...
																					<tr>
																						<td>
																							<table width="96%" align="center" border="0"
																								cellspacing="0" cellpadding="0">
																								<tr bgcolor="#ECECEC" height="28" cols="2">
																								...
																								<%
																									if (listUnitsize != null) {
																										for (int i = 0; i < listUnitsize.size(); i++) {
																							            Map<String, Object> row = new HashMap<String, Object>();
																							            row = listUnitsize.get(i);
																							            String allocation_unit_size = (String) row
																							                    .get("allocation_unit_size");
																							            String name = (String) row.get("name");
																							            String total_mb = (String) row.get("total_mb");
																					...
																					<tr>
																						<td>
																							<table width="96%" align="center" border="0"
																								...
																								<%
																									if (listFailgroup != null) {
																								 		for (int i = 0; i < listFailgroup.size(); i++) {
																							            	Map<String, Object> row = new HashMap<String, Object>();
																							            	row = listFailgroup.get(i);
																							            	String label = (String) row.get("label");
																							            	String name = (String) row.get("name");
																							            	String failgroup = (String) row.get("failgroup");
