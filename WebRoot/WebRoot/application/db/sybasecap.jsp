																					...
																					<table width="100%" border="0" cellpadding="3"
																						...
																						<tr bgcolor="#FFFFFF" height=28
																							...
																							<%
																								...
																								System.out.println(sysbaseVO.getMaxconn()+"==="+sysbaseVO.getUsedconn());
																							%>
																							<td width="20%"
																								class="application-detail-data-body-list"><%=Integer.parseInt(sysbaseVO.getMaxconn())-Integer.parseInt(sysbaseVO.getUsedconn())%></td>
																							<td width="30%"
																								class="application-detail-data-body-list">
																								用户连接数使用率
																							</td>
																							<td width="20%"
																								class="application-detail-data-body-list"><%=Math.round(Integer.parseInt(sysbaseVO.getUsedconn())*100/Integer.parseInt(sysbaseVO.getMaxconn()))%>%</td>
																						</tr>
																						<tr bgcolor="#FFFFFF" height=28
																							<%=onmouseoverstyle%>>
																							<td width="30%"
