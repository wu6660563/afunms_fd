			...
			<tr>
				<td background="<%=rootPath%>/common/images/right_t_02.jpg" width="100%"><table width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td class="layout_title">系统管理 >> 资源管理 >> 防火墙类型列表</td>
		...
		<tr >
			<td colspan="2">
				<table cellspacing="1" cellpadding="0" width="100%" >
					...
					<th width='5%'></th>
    					<th width='5%'>序号</th>
    					<th width='30%'>防火墙类型</th>
    					<th width='30%'>防火墙类型描述</th>
    					<th width='30%'>操作</th>
					</tr>
<%
if(rc > 0){
...
%>
       <tr bgcolor="#FFFFFF" <%=onmouseoverstyle%> class="microsoftLook">
		...
		<td height=25><%=vo.getFirewalltype()%></td> 
		<td height=25><%=vo.getFirewalldesc()%></td> 		
		<td height=25><a href="<%=rootPath%>/fwtype.do?action=ready_edit&id=<%=vo.getId()%>">
