	...
	<body id="body" class="body" onload="initmenu();" >
		...
		<div id="itemMenu" style="display: none";>
			<table border="1" width="100%" height="100%" bgcolor="#F1F1F1"
				...
				<tr>
					<td style="cursor: default; border: outset 1;" align="center"
						onclick="parent.showHistory()">查看详情</td>
				</tr>
			</table>
		</div>
		<!-- 右键菜单结束-->
					        									    ...
					        									    if(list!=null&& list.size()>0){
					        									        for(int i = 0 ; i < list.size() ; i++){
					        									            ...
					        									            <tr <%=onmouseoverstyle%>>
								        										...
								        										<!-- 
								        										<td align="center" class="body-data-list"><img style="display: <//%=updateOperationDisable%>" src="<//%=rootPath%>/resource/image/status.gif" border="0" width="15" alt="右键操作" oncontextmenu=showMenu('2','<//%=processGroup.getId()%>','<//%=processGroup.getNodeid()%>')></td>
								        										 -->
