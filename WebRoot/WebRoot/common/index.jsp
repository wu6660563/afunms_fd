...
<frameset rows="95,*" frameborder="no" border="0" framespacing="0">
  <frame src="<%=rootPath%>/common/top.jsp" width="100%" marginwidth="0" marginheight="0" name="topFrame" scrolling="No" noresize="noresize" id="topFrame" title="topFrame" height="140"/>
  <frame src="<%=rootPath%>/user.do?action=home" id="mainFrame" scrolling="auto" name="mainFrame" width="100%" marginwidth="0" marginheight="0" frameborder="NO" frameborder="0" height="100%" />
</frameset>
