					...
					<table cellSpacing="0" cellPadding="0" width="100%" border="0" align='left'>
						...
						<tr>
							<td colspan="2" align='center'>
								...
								<tr><th width='70%'bgcolor="#ECECEC" height="28">种子地址</th></tr>
		     <tr height=30>
...
<!--================其他种子地址与共同体===========================-->  	 
  	 <tr><th width='70%' align="center" bgcolor="#ECECEC" height="28">其他种子地址</th></tr>
     <tr >
    	<td  align="center" bgcolor="#ECECEC">&nbsp;           
...
<!--================全局共同体===========================-->  	 
  	 <tr><th width='70%' align="center" bgcolor="#ECECEC" height="28">全局共同体</th></tr>
     <tr >
    	<td  align="center" bgcolor="#ECECEC">&nbsp;           
...
<!--================指定设备节点共同体===========================--> 
  	 ...
  	 <tr><th width='60%' align="center" bgcolor="#ECECEC" height="28">特定设备节点共同体</th></tr>
     <tr >
    	<td align="center" bgcolor="#ECECEC">&nbsp;&nbsp;&nbsp;
...
<!--================只发现以下网段设备===========================-->  	
  	 <tr><th width='70%' align="center" bgcolor="#ECECEC" height="28">只发现以下的网段</th></tr>
     <tr>
    	<td align="center" bgcolor="#ECECEC">&nbsp;           
...
<!--================要屏蔽的IP===========================-->  	
  	 <tr><th width='70%' align="center" bgcolor="#ECECEC" height="28">要屏蔽的IP</th></tr>
     <tr >
    	<td align="center" bgcolor="#ECECEC">&nbsp;           
           网段地址:<input type="text" name="net_address" size="20" class="formStyle">&nbsp;&nbsp;&nbsp;&nbsp;
...
<!--================要屏蔽的网段===========================-->  	 
  	 <tr><th width='70%' align="center" bgcolor="#ECECEC" height="28">要屏蔽的网段</th></tr>
     <tr >
    	<td align="center" bgcolor="#ECECEC">&nbsp;           
           <!--网段地址:<input type="text" name="net_address" size="20" class="formStyle">&nbsp;&nbsp;&nbsp;&nbsp;-->
...
<%}%>
						...
						<tr>	
				<TD bgcolor="#ECECEC" height="24" align='center'>设置所属业务&nbsp;
