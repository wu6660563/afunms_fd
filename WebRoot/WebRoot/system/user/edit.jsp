...
<%
   ...
   String rootPath = request.getContextPath();
    ...
    String updateOperationDisabled = "";
    if (!isUpdateOperation) {
        updateOperationDisable = "none";
        updateOperationDisabled = "disabled=\"disabled\"";
    }
				...
				<td class="td-container-main">
					<table id="container-main" class="container-main">
						...
						<tr style="background-color: #ECECEC;">
							...
							<td colspan="3" align="left">&nbsp;<%=view.getRoleBox(vo.getRole(),operator.getRole(), isUpdateOperation)%></td>
						</tr>
						<tr>
							<TD nowrap align="right" height="24">部门&nbsp;</TD>			
							<TD nowrap>&nbsp;<%=view.getDeptBox(vo.getDept(), isUpdateOperation)%></TD>								
							<td align="right" height="20">职务&nbsp;</td>
							<td colspan="3" align="left">&nbsp;<%=view.getPositionBox(vo.getPosition(), isUpdateOperation)%></td>
						</tr>
						<tr style="background-color: #ECECEC;">
						...
						<tr style="background-color: #ECECEC;">	
							...
							%>   
							<input <%=updateOperationDisabled%> type=text readonly="readonly" onclick='setBid("bidtext" , "bid");' id="bidtext" name="bidtext" size="50" maxlength="32" value="<%=bussName%>">&nbsp;&nbsp;<input type=button value="设置所属业务" style="display: <%=updateOperationDisable%>" onclick='setBid("bidtext" , "bid");'>
