			...
			<tr>
				<td background="<%=rootPath%>/common/images/right_t_02.jpg" width="100%"><table width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td class="layout_title">系统管理 >> 角色管理 >>修改个人设置</td>
			...
			<table width="100%"  border="0" cellpadding="1" cellspacing="1">
  			<tr>
  				<td valign="top" bgcolor="#FFFFFF" align="center" colspan="2">
					<!--table begin-->
					<table width="50%" border="1" cellpadding="0" cellspacing="1" bordercolorlight='#000000' bordercolordark='#FFFFFF'>
  						<tr class="othertr1"><td align="center" bgcolor="#ECECEC" height="30">请输入您的密码:</td></tr>
					...
					<!--table end-->
      				...
      				<td width="100%" bgcolor="#FFFFFF" align="center" height="10">
