			...
			<tr>
				<td background="<%=rootPath%>/common/images/right_t_02.jpg" width="100%"><table width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td class="layout_title">系统管理 >> 用户管理 >> 菜单设置</td>
        			...
        			<tr>
					 ...
					 <input id=menuAdd" class="button" type="button" value="增加" onclick="toAdd();">&nbsp;&nbsp;&nbsp;
					</tr>
        								</table>
										</td>
        						</tr>			
						...
						<tr class="microsoftLook0" height=28>
							...
							<td align=center>
								...
								<input id="rootMenuEdit" class="button" type="button" value="编辑" onclick="toEdit();">
								<input id="rootMenuDelete" class="button" type="button" value="删除" onclick="toDelete();">
						...
						<tr class="microsoftLook0" height=28>
							...
							<td align=center>
								...
								<input id="secondMenuEdit" class="button" type="button" value="编辑" onclick="toEdit();">
								<input id="secondMenuDelete" class="button" type="button" value="删除" onclick="toDelete();">
						...
						<tr class="microsoftLook0" height=28>
							...
							<td align=center>
								...
								<input id="thirdMenuEdit" class="button" type="button" value="编辑" onclick="toEdit();">
								<input id="thirdMenuDelete" class="button" type="button" value="删除" onclick="toDelete();">
