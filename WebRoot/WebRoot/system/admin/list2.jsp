						...
						<tr>
							...
							<tr class="microsoftLook0" >
								 ...
								 -->
				        									...
				        									<tr>
							                   <td bgcolor="#ffffff" style="display: <%=updateOperationDisable%>" colspan="5" align=center><input id="write" type="button" class="button" value="确定" name="B2" onclick="toUpdate()"></td>
						         </tr>
				        								</table>
				        							</td>
				        						</tr>
