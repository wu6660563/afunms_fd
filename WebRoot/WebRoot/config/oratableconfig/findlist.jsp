...
<script language="javascript">	
  ...
  var delAction = "<%=rootPath%>/oratablespaconfig.do?action=delete";
  var listAction = "<%=rootPath%>/oratablespaconfig.do?action=find";
  
  function doQuery()
  {  
     mainForm.action = "<%=rootPath%>/oratablespaconfig.do?action=find";
     mainForm.submit();
  }
  function doFromlastoconfig()
  {  
     mainForm.action = "<%=rootPath%>/oratablespaconfig.do?action=fromlasttoconfig";
     mainForm.submit();
  }  
			...
			<tr>
				<td background="<%=rootPath%>/common/images/right_t_02.jpg" width="100%"><table width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td class="layout_title"><b>资源 >> 性能监视 >> Oracle表空间阀值一览</b></td>
									...
									<table cellspacing="1" cellpadding="0" width="100%">
	  									<tr class="microsoftLook0">
	  										<th width='5%'><INPUT type="checkbox" class=noborder name="checkall" onclick="javascript:chkall()"></th>
      											<td width="8%" align="center"><strong>IP地址</strong></td>  
      											<td width="7%" align="center"><strong>数据库</strong></td>  
      											<td width="8%" align="center"><strong>表空间</strong></td>  
    											<td width="10%" align="center"><strong>文件名称</strong></td>    
    											<td width="5%" align="center"><strong>是否告警</strong></td>
...
OracleTableSpaceConfig vo = null;
    ...
    for(int i=0;i<rc;i++)
    {
       vo = (OracleTableSpaceConfig)list.get(i);
...
%>
   										<tr bgcolor="#FFFFFF" <%=onmouseoverstyle%>>  
    											...
    											<td  align='center'><%=vo.getDbName()%></td>
    											<td  align='center'><%=vo.getTableSpace()%></td>
											...
											<td  align='center'><a href="javascript:void(null)" onClick='window.open("<%=rootPath%>/oratablespaconfig.do?action=showedit&id=<%=vo.getId()%>","editdiskconfig", "height=400, width= 500, top=200, left= 200")'>
