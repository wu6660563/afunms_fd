		        										...
		        										<td>
		        											<table cellspacing="0" border="1" bordercolor="#ababab">
		        												<tr height=28 style="background:#ECECEC" align="center" class="content-title">
		        													<td align="center"><input type=checkbox name="checkall" onclick="javascript:chkall()"  class="noborder">IP地址</td>
		        													<td align="center">用户名</td>
		        													<td align="center">密码</td>
		        													<td align="center">su名</td>
		        													<td align="center">su密码</td>
		        												...
		        												<%
			        												...
			        												for (int i = 0; i < list.size(); i++) {
			        													...
			        													<tr <%=onmouseoverstyle%>>
											        						...
											        						<td align='center'>
											        							<input type="checkbox"  class="noborder" name="id" value="<%=vo.getIpaddress()%>"/><%=vo.getIpaddress()%>
																			</td>
			        														<td align='center'><%=vo.getUser()%></td>
			        														<td align='center'><%=vo.getPassword()%></td>
			        														<td align='center'><%=vo.getSuuser()%></td>
			        														<td align='center'><%=vo.getSupassword()%></td>
