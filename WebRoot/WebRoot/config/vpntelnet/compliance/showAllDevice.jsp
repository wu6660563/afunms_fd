											...
											<td>
												...
												<table class="tool-bar-body-list" border=1>
												 ...
												 <ul>
													...
													<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<%=rootPath%>/resource/image/toolbar/telnet.gif">&nbsp;<a href="#" onClick="setStrategy()">策略设置</a></li>
													<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<%=rootPath%>/resource/image/toolbar/lygz.gif">&nbsp;<a href="#" onClick="setGroup()">规则组设置</a></li>
													<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<%=rootPath%>/resource/image/toolbar/snmpping.gif">&nbsp;<a href="#" onClick='setRule()'>规则设置</a></li>
	               									<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<%=rootPath%>/resource/image/toolbar/sbmb.gif">&nbsp;<a href="#" onClick=''>导出报表</a></li>
