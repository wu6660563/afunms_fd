...
function showdiv(id)
{
  ...
  function toEdit()
  {
   ...
   var smsUseValue= document.all.sms.value;
   var importantUseValue= document.all.important.value;
     ...
     if(chk)
     {
     	if (confirm("确定要修改吗?")){
            ...
            if(importantUseValue==0) {
                isImportant = "否";
            } else {
                isImportant = "是";
            }
            
            var isSmsId =window.opener.document.getElementById("isSMS<%=id%>");
        	useId.innerHTML=linkUseValue;
            isSmsId.innerHTML=isSms;
            var isImportantId =window.opener.document.getElementById("isImportant<%=id%>");
            isImportantId.innerHTML=isImportant;
        	alert("修改成功!");
			...
			<tr>
			  	...
			  	<td height=380 bgcolor="#FFFFFF" valign="top" align=center>	
					...
					<table width="80%" style="BORDER-COLLAPSE: collapse" borderColor=#cedefa cellPadding=0 rules=none align=center border=1 algin="center">
                				...
                				<tr bgcolor="#F1F1F1">
                  					<TD nowrap align="right" height="24" width="10%">端口Down是否告警&nbsp;</TD>
                  					<TD nowrap width="40%">&nbsp;
                  					<select name="sms">
                                ...
                                <tr bgcolor="#F1F1F1">
                                    <TD nowrap align="right" height="24" width="10%">关键端口&nbsp;</TD>
                                    <TD nowrap width="40%">&nbsp;
                                    <select name="important">
                                    <option value="0" <%=important%>>否</option>
                                    <option value="1" <%=important%>>是</option>
                                    </select>
